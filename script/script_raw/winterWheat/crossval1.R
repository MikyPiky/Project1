...
for(r in 1:9){
  ...
  save.image(file = "/home/peichl/projects/crossvalid/cross1.RData")
}

BIC_loop_Sep <- BIC_loop_2v8poly_Prec
cv.error_loocv_Sep <- cv.error_loocv_2v8poly_Prec

par(mfrow=c(2,2))
plot(BIC_loop_2v8poly_Prec)
plot(cv.error_loocv_2v8poly_Prec)
plot(BIC_loop_Sep)
plot(cv.error_loocv_Sep)
...
Yield_Covariates_nna_plm$SMI_Sep_within <- Within(Yield_Covariates_nna_plm$SMI_Sep)
Yield_Covariates_nna_plm$Prec_Sep_within <- Within(Yield_Covariates_nna_plm$Prec_Sep)
Yield_Covariates_nna_plm$Prec_Sep_within <- Within(Yield_Covariates_nna_plm$Tavg_Sep)
Yield_Covariates_nna_plm$SMI_Sep_GDM_within <- Within(Yield_Covariates_nna_plm$SMI_Sep_GDM)
summary(Yield_Covariates_nna_plm$Prec_Sep$)
