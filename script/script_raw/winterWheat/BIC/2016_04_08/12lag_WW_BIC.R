...
Yield_Covariates_ww_Dec_lag <- cbind(Yield_Covariates_ww, Yield_Covariates_Dec_lag)
names(Yield_Covariates_ww_Dec_lag)
names(Yield_Covariates_ww_Dec_lag) <- c( "comId" , "year","com","stateId","state","winterWheat","SMI", "Prec","Tavg", "Pet", "Tmin_Dec_lag", "Tmax_Dec_lag")
names(Yield_Covariates_ww_Dec_lag)
...
head(Yield_Covariates_ww_Dec_lag_nna)
...
# ## Leverage one ##
# # Warnings in plot()
# Yield_Covariates_ww_Dec_lag[c(181, 182, 765, 851, 1006, 1557) ,]
# 
# # Crucial Observations in plot()
# Yield_Covariates_ww_Dec_lag[c(3335,3673,3219, 3681, 1557),]

## Anschauem der Struktur der coms, welche hier ausgegeben wurden: hier sind vor allem die winterWheat Werte relevant ##
# Yield_Covariates_ww_Dec_lag[Yield_Covariates_ww_Dec_lag$comId == "3101",] # < 1 Beobachtung
# Yield_Covariates_ww_Dec_lag[Yield_Covariates_ww_Dec_lag$comId == "3102",] # # < 1 Beobachtung
# Yield_Covariates_ww_Dec_lag[Yield_Covariates_ww_Dec_lag$comId == "5314",] # < 1 Beobachtung 
# Yield_Covariates_ww_Dec_lag[Yield_Covariates_ww_Dec_lag$comId == "5512",] # < 1 Beobachtung
# Yield_Covariates_ww_Dec_lag[Yield_Covariates_ww_Dec_lag$comId == "5911",] # < 1 Beobachtung
# Yield_Covariates_ww_Dec_lag[Yield_Covariates_ww_Dec_lag$comId == "7331",] # < 1 Beobachtung
# 
# Yield_Covariates_ww_Dec_lag[Yield_Covariates_ww_Dec_lag$comId == "15001",] # < 4 Beobachtungen
# Yield_Covariates_ww_Dec_lag[Yield_Covariates_ww_Dec_lag$comId == "12069",] # hier mache ich am besten nichts
# Yield_Covariates_ww_Dec_lag[Yield_Covariates_ww_Dec_lag$comId == "14730",] # hier mache ich auch am besten nichts
# Yield_Covariates_ww_Dec_lag[Yield_Covariates_ww_Dec_lag$comId == "12053",] # hier mache ich auch am besten nichts
...
attach(Yield_Covariates_ww_Dec_lag)
...
#####################
## Attach Data Set ##
head(Yield_Covariates_ww_Dec_lag)
dim(Yield_Covariates_ww_Dec_lag)
attach(Yield_Covariates_ww_Dec_lag)
...
## Print formula
formula_Dec_lag_ww_detrendlog_SMIPrecTavg
formula_Dec_lag_ww_detrendlog_SMIPrecPet
formula_Dec_lag_ww_detrendlog_SMIPrec
formula_Dec_lag_ww_detrendlog_SMIPet
formula_Dec_lag_ww_detrendlog_SMITavg
formula_Dec_lag_ww_detrendlog_SMI
formula_Dec_lag_ww_detrendlog_PrecTavg
formula_Dec_lag_ww_detrendlog_PrecPet
formula_Dec_lag_ww_detrendlog_Prec
formula_Dec_lag_ww_detrendlog_Pet 
formula_Dec_lag_ww_detrendlog_Tavg
...
# cv.error_loocv_Dec_lag_winterWheat <- cv.error
...
BIC_WW_12lag <- BIC2
class(BIC_WW_12lag)
write.csv(BIC_WW_12lag, file="./data/data_raw/BIC/BIC_WW_12lag.csv")