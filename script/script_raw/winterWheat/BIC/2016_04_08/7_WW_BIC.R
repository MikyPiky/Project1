...
Yield_Covariates_ww_Jul <- cbind(Yield_Covariates_ww, Yield_Covariates_Jul)
names(Yield_Covariates_ww_Jul)
names(Yield_Covariates_ww_Jul) <- c( "comId" , "year","com","stateId","state","winterWheat","SMI", "Prec","Tavg", "Pet", "Tmin_Jul", "Tmax_Jul")
names(Yield_Covariates_ww_Jul)
...
head(Yield_Covariates_ww_Jul_nna)
...
# ## Leverage one ##
# # Warnings in plot()
# Yield_Covariates_ww_Jul[c(181, 182, 765, 851, 1006, 1557) ,]
# 
# # Crucial Observations in plot()
# Yield_Covariates_ww_Jul[c(3335,3673,3219, 3681, 1557),]

## Anschauem der Struktur der coms, welche hier ausgegeben wurden: hier sind vor allem die winterWheat Werte relevant ##
# Yield_Covariates_ww_Jul[Yield_Covariates_ww_Jul$comId == "3101",] # < 1 Beobachtung
# Yield_Covariates_ww_Jul[Yield_Covariates_ww_Jul$comId == "3102",] # # < 1 Beobachtung
# Yield_Covariates_ww_Jul[Yield_Covariates_ww_Jul$comId == "5314",] # < 1 Beobachtung 
# Yield_Covariates_ww_Jul[Yield_Covariates_ww_Jul$comId == "5512",] # < 1 Beobachtung
# Yield_Covariates_ww_Jul[Yield_Covariates_ww_Jul$comId == "5911",] # < 1 Beobachtung
# Yield_Covariates_ww_Jul[Yield_Covariates_ww_Jul$comId == "7331",] # < 1 Beobachtung
# 
# Yield_Covariates_ww_Jul[Yield_Covariates_ww_Jul$comId == "15001",] # < 4 Beobachtungen
# Yield_Covariates_ww_Jul[Yield_Covariates_ww_Jul$comId == "12069",] # hier mache ich am besten nichts
# Yield_Covariates_ww_Jul[Yield_Covariates_ww_Jul$comId == "14730",] # hier mache ich auch am besten nichts
# Yield_Covariates_ww_Jul[Yield_Covariates_ww_Jul$comId == "12053",] # hier mache ich auch am besten nichts
...
attach(Yield_Covariates_ww_Jul)
...
## Print formula
formula_Jul_ww_detrendlog_SMIPrecTavg
formula_Jul_ww_detrendlog_SMIPrecPet
formula_Jul_ww_detrendlog_SMIPrec
formula_Jul_ww_detrendlog_SMIPet
formula_Jul_ww_detrendlog_SMITavg
formula_Jul_ww_detrendlog_SMI
formula_Jul_ww_detrendlog_PrecTavg
formula_Jul_ww_detrendlog_PrecPet
formula_Jul_ww_detrendlog_Prec
formula_Jul_ww_detrendlog_Pet 
formula_Jul_ww_detrendlog_Tavg
...
# cv.error_loocv_Jul_winterWheat <- cv.error
...
BIC_WW_7 <- BIC2
class(BIC_WW_7)
write.csv(BIC_WW_7, file="./data/data_raw/BIC/BIC_WW_7.csv")
