...
Yield_Covariates_ww_Apr <- cbind(Yield_Covariates_ww, Yield_Covariates_Apr)
names(Yield_Covariates_ww_Apr)
names(Yield_Covariates_ww_Apr) <- c( "comId" , "year","com","stateId","state","winterWheat","SMI", "Prec","Tavg", "Pet", "Tmin_Apr", "Tmax_Apr")
names(Yield_Covariates_ww_Apr)
...
head(Yield_Covariates_ww_Apr_nna)
...
# ## Leverage one ##
# # Warnings in plot()
# Yield_Covariates_ww_Apr[c(181, 182, 765, 851, 1006, 1557) ,]
# 
# # Crucial Observations in plot()
# Yield_Covariates_ww_Apr[c(3335,3673,3219, 3681, 1557),]

## Anschauem der Struktur der coms, welche hier ausgegeben wurden: hier sind vor allem die winterWheat Werte relevant ##
# Yield_Covariates_ww_Apr[Yield_Covariates_ww_Apr$comId == "3101",] # < 1 Beobachtung
# Yield_Covariates_ww_Apr[Yield_Covariates_ww_Apr$comId == "3102",] # # < 1 Beobachtung
# Yield_Covariates_ww_Apr[Yield_Covariates_ww_Apr$comId == "5314",] # < 1 Beobachtung 
# Yield_Covariates_ww_Apr[Yield_Covariates_ww_Apr$comId == "5512",] # < 1 Beobachtung
# Yield_Covariates_ww_Apr[Yield_Covariates_ww_Apr$comId == "5911",] # < 1 Beobachtung
# Yield_Covariates_ww_Apr[Yield_Covariates_ww_Apr$comId == "7331",] # < 1 Beobachtung
# 
# Yield_Covariates_ww_Apr[Yield_Covariates_ww_Apr$comId == "15001",] # < 4 Beobachtungen
# Yield_Covariates_ww_Apr[Yield_Covariates_ww_Apr$comId == "12069",] # hier mache ich am besten nichts
# Yield_Covariates_ww_Apr[Yield_Covariates_ww_Apr$comId == "14730",] # hier mache ich auch am besten nichts
# Yield_Covariates_ww_Apr[Yield_Covariates_ww_Apr$comId == "12053",] # hier mache ich auch am besten nichts
...
attach(Yield_Covariates_ww_Apr)
...
## Print formula
formula_Apr_ww_detrendlog_SMIPrecTavg
formula_Apr_ww_detrendlog_SMIPrecPet
formula_Apr_ww_detrendlog_SMIPrec
formula_Apr_ww_detrendlog_SMIPet
formula_Apr_ww_detrendlog_SMITavg
formula_Apr_ww_detrendlog_SMI
formula_Apr_ww_detrendlog_PrecTavg
formula_Apr_ww_detrendlog_PrecPet
formula_Apr_ww_detrendlog_Prec
formula_Apr_ww_detrendlog_Pet 
formula_Apr_ww_detrendlog_Tavg
...
# cv.error_loocv_Apr_winterWheat <- cv.error
...
BIC_WW_4 <- BIC2
class(BIC_WW_4)
write.csv(BIC_WW_4, file="./data/data_raw/BIC/BIC_WW_4.csv")
