...
Yield_Covariates_ww_Aug <- cbind(Yield_Covariates_ww, Yield_Covariates_Aug)
names(Yield_Covariates_ww_Aug)
names(Yield_Covariates_ww_Aug) <- c( "comId" , "year","com","stateId","state","winterWheat","SMI", "Prec","Tavg", "Pet", "Tmin_Aug", "Tmax_Aug")
names(Yield_Covariates_ww_Aug)
...
head(Yield_Covariates_ww_Aug_nna)
...
# ## Leverage one ##
# # Warnings in plot()
# Yield_Covariates_ww_Aug[c(181, 182, 765, 851, 1006, 1557) ,]
# 
# # Crucial Observations in plot()
# Yield_Covariates_ww_Aug[c(3335,3673,3219, 3681, 1557),]

## Anschauem der Struktur der coms, welche hier ausgegeben wurden: hier sind vor allem die winterWheat Werte relevant ##
# Yield_Covariates_ww_Aug[Yield_Covariates_ww_Aug$comId == "3101",] # < 1 Beobachtung
# Yield_Covariates_ww_Aug[Yield_Covariates_ww_Aug$comId == "3102",] # # < 1 Beobachtung
# Yield_Covariates_ww_Aug[Yield_Covariates_ww_Aug$comId == "5314",] # < 1 Beobachtung 
# Yield_Covariates_ww_Aug[Yield_Covariates_ww_Aug$comId == "5512",] # < 1 Beobachtung
# Yield_Covariates_ww_Aug[Yield_Covariates_ww_Aug$comId == "5911",] # < 1 Beobachtung
# Yield_Covariates_ww_Aug[Yield_Covariates_ww_Aug$comId == "7331",] # < 1 Beobachtung
# 
# Yield_Covariates_ww_Aug[Yield_Covariates_ww_Aug$comId == "15001",] # < 4 Beobachtungen
# Yield_Covariates_ww_Aug[Yield_Covariates_ww_Aug$comId == "12069",] # hier mache ich am besten nichts
# Yield_Covariates_ww_Aug[Yield_Covariates_ww_Aug$comId == "14730",] # hier mache ich auch am besten nichts
# Yield_Covariates_ww_Aug[Yield_Covariates_ww_Aug$comId == "12053",] # hier mache ich auch am besten nichts
...
attach(Yield_Covariates_ww_Aug)
...
## Print formula
formula_Aug_ww_detrendlog_SMIPrecTavg
formula_Aug_ww_detrendlog_SMIPrecPet
formula_Aug_ww_detrendlog_SMIPrec
formula_Aug_ww_detrendlog_SMIPet
formula_Aug_ww_detrendlog_SMITavg
formula_Aug_ww_detrendlog_SMI
formula_Aug_ww_detrendlog_PrecTavg
formula_Aug_ww_detrendlog_PrecPet
formula_Aug_ww_detrendlog_Prec
formula_Aug_ww_detrendlog_Pet 
formula_Aug_ww_detrendlog_Tavg
...
# cv.error_loocv_Aug_winterWheat <- cv.error
...
BIC_WW_8 <- BIC2
class(BIC_WW_8)
write.csv(BIC_WW_8, file="./data/data_raw/BIC/BIC_WW_8.csv")
