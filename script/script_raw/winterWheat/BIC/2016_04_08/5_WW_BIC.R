...
Yield_Covariates_ww_Mai <- cbind(Yield_Covariates_ww, Yield_Covariates_Mai)
names(Yield_Covariates_ww_Mai)
names(Yield_Covariates_ww_Mai) <- c( "comId" , "year","com","stateId","state","winterWheat","SMI", "Prec","Tavg", "Pet", "Tmin_Mai", "Tmax_Mai")
names(Yield_Covariates_ww_Mai)
...
Yield_Covariates_ww_Mai$SMI_GDM <- cut(Yield_Covariates_ww_Mai$SMI, breaks = c(0, 0.1, 0.2, 0.3, 0.7, 0.8, 0.9, 1),                                            ,
                                       labels = c("severe drought","moderate drought","abnormal dry", "normal","abnormal wet" ,"abundant wet", "severe wet"))
#############
## Na-omit ##
sum(is.na(Yield_Covariates_ww_Mai) )
dim(Yield_Covariates_ww_Mai)
Yield_Covariates_ww_Mai_nna <- na.omit(Yield_Covariates_ww_Mai) 
dim(Yield_Covariates_ww_Mai_nna)
any(is.na(Yield_Covariates_ww_Mai_nna))
rownames(Yield_Covariates_ww_Mai_nna) <- NULL
head(Yield_Covariates_ww_Mai_nna)

## Further work with DataFrame without Yield_Covariates_ww_Mai index ##
Yield_Covariates_ww_Mai <- Yield_Covariates_ww_Mai_nna
...
# ## Leverage one ##
# # Warnings in plot()
# Yield_Covariates_ww_Mai[c(181, 182, 765, 851, 1006, 1557) ,]
# 
# # Crucial Observations in plot()
# Yield_Covariates_ww_Mai[c(3335,3673,3219, 3681, 1557),]

## Anschauem der Struktur der coms, welche hier ausgegeben wurden: hier sind vor allem die winterWheat Werte relevant ##
# Yield_Covariates_ww_Mai[Yield_Covariates_ww_Mai$comId == "3101",] # < 1 Beobachtung
# Yield_Covariates_ww_Mai[Yield_Covariates_ww_Mai$comId == "3102",] # # < 1 Beobachtung
# Yield_Covariates_ww_Mai[Yield_Covariates_ww_Mai$comId == "5314",] # < 1 Beobachtung 
# Yield_Covariates_ww_Mai[Yield_Covariates_ww_Mai$comId == "5512",] # < 1 Beobachtung
# Yield_Covariates_ww_Mai[Yield_Covariates_ww_Mai$comId == "5911",] # < 1 Beobachtung
# Yield_Covariates_ww_Mai[Yield_Covariates_ww_Mai$comId == "7331",] # < 1 Beobachtung
# 
# Yield_Covariates_ww_Mai[Yield_Covariates_ww_Mai$comId == "15001",] # < 4 Beobachtungen
# Yield_Covariates_ww_Mai[Yield_Covariates_ww_Mai$comId == "12069",] # hier mache ich am besten nichts
# Yield_Covariates_ww_Mai[Yield_Covariates_ww_Mai$comId == "14730",] # hier mache ich auch am besten nichts
# Yield_Covariates_ww_Mai[Yield_Covariates_ww_Mai$comId == "12053",] # hier mache ich auch am besten nichts
...
sum(table(Yield_Covariates_ww_Mai$comId) < 7 )
table(Yield_Covariates_ww_Mai$comId) < 7 
...
temp <- Yield_Covariates_ww_Mai
for (i in 1:20)
{
  print(Yield_Covariates_ww_Mai[Yield_Covariates_ww_Mai$comId==list[[i]],])
  temp <- (temp[!temp$comId==list[i],])
}

dim(temp)-dim(Yield_Covariates_ww_Mai)

Yield_Covariates_ww_Mai <- temp

################################
## Befehle nach jedem löschen ##
Yield_Covariates_ww_Mai <- na.omit(Yield_Covariates_ww_Mai) 
rownames(Yield_Covariates_ww_Mai) <- NULL
Yield_Covariates_ww_Mai <- plm.data(Yield_Covariates_ww_Mai, index=c("comId", "year"))
Yield_Covariates_ww_Mai[,c("comId","stateId")] <- lapply(Yield_Covariates_ww_Mai[,c("comId","stateId")], factor )

attach(Yield_Covariates_ww_Mai)

#################################################
#### Remove log trend of indepedent variable ####
##################################################
'Fit log of yield on log of time and use the residuals of that for yields'
logtrend <- lm(log(winterWheat) ~ log(as.integer(year)), data= Yield_Covariates_ww_Mai)
...
Yield_Covariates_ww_Mai[c(3382, 3442, 3454, 2574,3451,3511),]
## Look at other values of outliers com #
Yield_Covariates_ww_Mai[Yield_Covariates_ww_Mai$comId == "12060",] #2003
Yield_Covariates_ww_Mai[Yield_Covariates_ww_Mai$comId == "12065",] #2003
Yield_Covariates_ww_Mai[Yield_Covariates_ww_Mai$comId == "12066",] #2003 
Yield_Covariates_ww_Mai[Yield_Covariates_ww_Mai$comId == "9276",] # 1999: hier sehe ich keinen Grund, warum die Daten geläscht werden sollten
Yield_Covariates_ww_Mai[Yield_Covariates_ww_Mai$comId == "12060",] # 2003
Yield_Covariates_ww_Mai[Yield_Covariates_ww_Mai$comId == "12071",] # 2000

## Interpretation ##
' Im Gegensatz zu SoliMoais nehme ich hier keine Beobachtungen wegen Outlier und  Leverage raus '
...
'Fit log of yield on log of time and use the residuals of that for yields'
logtrend <- lm(log(winterWheat) ~ log(as.integer(year)), data= Yield_Covariates_ww_Mai)
Yield_Covariates_ww_Mai$winterWheat_logtrend <- resid(logtrend)
...
Yield_Covariates_ww_Mai <- plm.data(Yield_Covariates_ww_Mai, index=c("comId", "year"))
str(Yield_Covariates_ww_Mai)

###########################################
## Transform comId and stateId to factor ##
Yield_Covariates_ww_Mai[,c("comId","stateId")] <- lapply(Yield_Covariates_ww_Mai[,c("comId","stateId")], factor )
lapply(Yield_Covariates_ww_Mai, class)

#####################
## Attach Data Set ##
head(Yield_Covariates_ww_Mai)
dim(Yield_Covariates_ww_Mai)
attach(Yield_Covariates_ww_Mai)
...
formula_Mai_ww_detrendlog_SMIPrecTavg <- winterWheat_logtrend ~ poly(Prec, degree[r, 1], raw = T) +  poly(Tavg, degree[r, 2], raw = T) + 
  dummy(SMI_GDM,c("severe drought","moderate drought","abnormal dry", "abnormal wet", "abundant wet","severe wet")) + dummy(comId)

formula_Mai_ww_detrendlog_SMIPrecPet <- winterWheat_logtrend ~ poly(Prec, degree[r, 1], raw = T) +  poly(Pet, degree[r, 2], raw = T) + 
  dummy(SMI_GDM,c("severe drought","moderate drought","abnormal dry", "abnormal wet", "abundant wet","severe wet")) + dummy(comId)

formula_Mai_ww_detrendlog_SMIPrec <- winterWheat_logtrend ~ poly(Prec, degree[r, 1], raw = T) +  
  dummy(SMI_GDM,c("severe drought","moderate drought","abnormal dry", "abnormal wet", "abundant wet","severe wet")) + dummy(comId)

formula_Mai_ww_detrendlog_SMIPet <- winterWheat_logtrend ~ poly(Pet, degree[r, 2], raw = T) +  
  dummy(SMI_GDM,c("severe drought","moderate drought","abnormal dry", "abnormal wet", "abundant wet","severe wet")) + dummy(comId)


formula_Mai_ww_detrendlog_SMITavg <- winterWheat_logtrend ~ poly(Tavg, degree[r, 2], raw = T) + 
  dummy(SMI_GDM,c("severe drought","moderate drought","abnormal dry", "abnormal wet", "abundant wet","severe wet")) + dummy(comId)

formula_Mai_ww_detrendlog_SMI <- winterWheat_logtrend ~  
  dummy(SMI_GDM,c("severe drought","moderate drought","abnormal dry", "abnormal wet", "abundant wet","severe wet")) + dummy(comId)

## no SMI

formula_Mai_ww_detrendlog_PrecTavg <- winterWheat_logtrend ~ poly(Prec, degree[r, 1], raw = T) +  poly(Tavg, degree[r, 2], raw = T) + dummy(comId)

formula_Mai_ww_detrendlog_PrecPet <- winterWheat_logtrend ~ poly(Prec, degree[r, 1], raw = T) +  poly(Pet, degree[r, 2], raw = T) + dummy(comId)

formula_Mai_ww_detrendlog_Prec <- winterWheat_logtrend ~ poly(Prec, degree[r, 1], raw = T) + dummy(comId)

formula_Mai_ww_detrendlog_Pet <- winterWheat_logtrend ~ poly(Pet, degree[r, 2], raw = T)  + dummy(comId)

formula_Mai_ww_detrendlog_Tavg <- winterWheat_logtrend ~ poly(Tavg, degree[r, 2], raw = T)  + dummy(comId)

## Print formula
formula_Mai_ww_detrendlog_SMIPrecTavg
formula_Mai_ww_detrendlog_SMIPrecPet
formula_Mai_ww_detrendlog_SMIPrec
formula_Mai_ww_detrendlog_SMIPet
formula_Mai_ww_detrendlog_SMITavg
formula_Mai_ww_detrendlog_SMI
formula_Mai_ww_detrendlog_PrecTavg
formula_Mai_ww_detrendlog_PrecPet
formula_Mai_ww_detrendlog_Prec
formula_Mai_ww_detrendlog_Pet 
formula_Mai_ww_detrendlog_Tavg
...
for(r in 1:9){
  glm.fit_SMIPrecTavg  <- glm(formula = formula_Mai_ww_detrendlog_SMIPrecTavg, data = Yield_Covariates_ww_Mai) 
  BIC_SMIPrecTavg[r] <- BIC(glm.fit_SMIPrecTavg)
}

BIC_SMIPrecPet <- rep(0,9)
for(r in 1:9){
  glm.fit_SMIPrecPet  <- glm(formula = formula_Mai_ww_detrendlog_SMIPrecPet,  data = Yield_Covariates_ww_Mai)
  BIC_SMIPrecPet[r] <- BIC(glm.fit_SMIPrecPet)
}

BIC_SMIPrec <- rep(0,9)
for(r in 1:9){  
  glm.fit_SMIPrec      <- glm(formula = formula_Mai_ww_detrendlog_SMIPrec,     data = Yield_Covariates_ww_Mai) 
  BIC_SMIPrec[r] <- BIC(glm.fit_SMIPrec)
}

BIC_SMIPet <- rep(0,9)
for(r in 1:9){  
  glm.fit_SMIPet       <- glm(formula = formula_Mai_ww_detrendlog_SMIPet,      data = Yield_Covariates_ww_Mai) 
  BIC_SMIPet[r] <- BIC(glm.fit_SMIPet)
}

BIC_SMITavg <- rep(0,9)
for(r in 1:9){  
  glm.fit_SMITavg      <- glm(formula = formula_Mai_ww_detrendlog_SMITavg,     data = Yield_Covariates_ww_Mai) 
  BIC_SMITavg[r] <- BIC(glm.fit_SMITavg)
}

BIC_SMI <- rep(0,9)
for(r in 1:9){  
  glm.fit_SMI      <- glm(formula = formula_Mai_ww_detrendlog_SMI,     data = Yield_Covariates_ww_Mai) 
  BIC_SMI[r] <- BIC(glm.fit_SMI)
}

BIC_PrecTavg <- rep(0,9)
for(r in 1:9){
  glm.fit_PrecTavg  <- glm(formula = formula_Mai_ww_detrendlog_PrecTavg, data = Yield_Covariates_ww_Mai) 
...
BIC_PrecPet <- rep(0,9)
for(r in 1:9){
  glm.fit_PrecPet  <- glm(formula = formula_Mai_ww_detrendlog_PrecPet, data = Yield_Covariates_ww_Mai) 
...
BIC_Prec <- rep(0,9)
for(r in 1:9){
  glm.fit_Prec  <- glm(formula = formula_Mai_ww_detrendlog_Prec, data = Yield_Covariates_ww_Mai) 
  BIC_Prec[r] <- BIC(glm.fit_Prec)
}

BIC_Pet  <- rep(0,9)
for(r in 1:9){
  glm.fit_Pet   <- glm(formula = formula_Mai_ww_detrendlog_Pet , data = Yield_Covariates_ww_Mai) 
  BIC_Pet [r] <- BIC(glm.fit_Pet )
}

BIC_Tavg  <- rep(0,9)
for(r in 1:9){
  glm.fit_Tavg   <- glm(formula = formula_Mai_ww_detrendlog_Tavg , data = Yield_Covariates_ww_Mai) 
...
# cv.error_loocv_Mai_winterWheat <- cv.error
...
BIC_WW_5 <- BIC2
class(BIC_WW_5)
write.csv(BIC_WW_5, file="./data/data_raw/BIC/BIC_WW_5.csv")
...
# dim( Yield_Covariates_ww_Mai)
# head(Yield_Covariates_ww_Mai)
# summary(Yield_Covariates_ww_Mai$winterWheat)
# hist(Yield_Covariates_ww_Mai$winterWheat)
# 
# 
...
# na.omit(Yield_Covariates_ww_Mai[rstd > 5 | rstd < -5,])  #11)
# 
# ## Generate data without outliers rstd > |6.5|
# na.omit(Yield_Covariates_ww_Mai[rstd > 6 | rstd < -6,])  
# dim(Yield_Covariates_ww_Mai)
# temp <-  Yield_Covariates_ww_Mai[!rstd > 6 & !rstd < -6,]
# dim(temp)
# 
...
r=5
glm.fit3 <- glm(formula = formula_Mai_ww_detrendlog,  data = temp)
summary(glm.fit3)
...
glm.fit4<- glm(formula = formula_Mai_ww_detrendlog,  data = temp1)
summary(glm.fit4)
plot(glm.fit4) 
...
glm.fit5<- glm(formula = formula_Mai_ww_detrendlog,  data = temp2)
summary(glm.fit5)
coeftest(glm.fit5)
plot(glm.fit5)
...
####################
## PLM Ergebnisse ##
plm.fit_Mai1 <- plm(formula = update(formula_Mai_ww_detrendlog, .~. - dummy(comId)),  data = Yield_Covariates_ww_Mai,  effect="individual", model=("within"), index = c("comId","year"))
summary(plm.fit_Mai1)

# no outliers
plm.fit_Mai2 <- plm(formula = update(formula_Mai_ww_detrendlog, .~. - dummy(comId)),  data = temp,  effect="individual", model=("within"), index = c("comId","year"))
...
plm.fit_Mai3 <- plm(formula = update(formula_Mai_ww_detrendlog, .~. - dummy(comId)),  data = temp1,  effect="individual", model=("within"), index = c("comId","year"))
...
plm.fit_Mai4 <- plm(formula = update(formula_Mai_ww_detrendlog, .~. - dummy(comId)),  data = temp2,  effect="individual", model=("within"), index = c("comId","year"))
summary(plm.fit_Mai4)
...
Mehr noch: da es keine Unterschiede zwischen plm.fit_Mai3 und plm.fit_Mai2 zu geben scheint, macht es wohl Sinn nur die outlier raus zu nehmen. 
...
mit leverage größer 1 rausnehme: plm.fit_Mai3 '
...
plm.fit_Mai_noPrec <- plm(formula = update(formula_Mai_ww_detrendlog, .~. - dummy(comId) - poly(Prec, degree[r, 1], raw = T)),  data = temp1,  effect="individual", model=("within"), index = c("comId","year"))
...
bptest(plm.fit_Mai, studentize = TRUE)
...
coeftest(plm.fit_Mai)
coeftest(plm.fit_Mai3,vcov=vcovHC)
' hier werden die Standardfehler teilweise sogar kleiner'


## Test ob andere Configuration heteroskedasdicity ausweisen
coeftest(plm.fit_Mai2,vcov=vcovHC(plm.fit_Mai1, method = "arellano", , type = "HC4"))
...
coeftest(plm.fit_Mai3,vcov=pvcovHC)
coeftest(plm.fit_Mai3,vcov=vcovHC(plm.fit_Mai2, type = "HC3"))

' Ich denke es macht Sinn das Modell 3 (plm.fit_Mai3 ) ohne outlier und weniger leverage zu nehmen. Darüberhinaus nehme ich arrelano als methode. Der Grund ist, dass durch 
...
pcdtest(plm.fit_Mai, test = c("lm"),index = c("comId","year"))
...
# Driscoll Kraay:
coeftest(plm.fit_Mai,vcov=function(x) vcovSCC(plm.fit_Mai,type = "HC4"), cluster="comId", maxlag=0, wj=function(j, maxlag) 1-j/(maxlag+1)) 
...
coeftest(plm.fit_Mai,vcov = vcovDC(plm.fit_Mai,type = "HC4"))
...
class(temp1$comId)
r <- 6
m <-felm( winterWheat_logtrend ~ poly(Prec, degree[r, 1], raw = T) + poly(Tavg,  degree[r, 2], raw = T) + 
...
## with comId clustering ##
m_geo <-felm( winterWheat_logtrend ~ poly(Prec, degree[r, 1], raw = T) + poly(Tavg,  degree[r, 2], raw = T) + 
...
summary(m_geo)
summary(plm.fit_Mai) # non clustered stanard error
coeftest(plm.fit_Mai, vcov=vcovHC(plm.fit_Mai)) # clustered standard errors, but no 
...
m_geo_time <-felm( winterWheat_logtrend ~ poly(Prec, degree[r, 1], raw = T) + poly(Tavg,  degree[r, 2], raw = T) + 
...
# BIC_noprec <- rep(0,3)
# for(r in 1:3){
#   glm.fit5 <- glm(formula = update(formula_Mai_ww_detrendlog, .~. - poly(Prec_Mai, degree[r, 1], raw = T)),  data = temp2) 
...
# #### Bootstrap ####
#########################################
# boot.fn = function (data ,index)  return(coef(  plm(formula = update(formula_Mai_ww_detrendlog, .~. - dummy(comId)),  data = temp2,  effect="individual", model=("within"), index = c("comId","year"))  ))
# 
# dim(temp2)
...
save("plm.fit_Mai3 ", file="/home/peichl/Documents/projects/correlation/script/script_raw/Crossvalidation/Output_Mai.RData")
...
summary(temp1$winterWheat_logtrend)
hist(temp1$winterWheat_logtrend)
## Temperature ##
coeftest(plm.fit_Mai,vcov=vcovHC(plm.fit_Mai3, method = "arellano", , type = "HC4"))
...
## Log
plot(temp1$Tavg, temp1$winterWheat_logtrend, main="Fitted Polynom of Temperature - Log")
summary(temp1$Tavg)
summary(temp1$winterWheat_logtrend)
...
## Exp
plot(Yield_Covariates_ww_Mai$Tavg, Yield_Covariates_ww_Mai$winterWheat- mean(Yield_Covariates_ww_Mai$winterWheat), main="Fitted Polynom of Temperature - Exp")
summary(Yield_Covariates_ww_Mai$Tavg)
xcurve <- seq(8.967, 17.4, 0.1)
...
## Log
plot(Yield_Covariates_ww_Mai$Prec, log(Yield_Covariates_ww_Mai$winterWheat - mean(Yield_Covariates_ww_Mai$winterWheat)), main="Fitted Polynom of Precipitation - Log")

summary(Yield_Covariates_ww_Mai$Prec)
...
## Exp
plot(Yield_Covariates_ww_Mai$Prec, Yield_Covariates_ww_Mai$winterWheat- mean(Yield_Covariates_ww_Mai$winterWheat), main="Fitted Polynom of Precipitation -Exp")
# plot(Yield_Covariates_ww_Mai$Prec, Yield_Covariates_ww_Mai$winterWheat, main="Fitted Polynom of Precipitation")
...
## Yield vs SMI ##
plot(temp1$SMI, SM_Mai$winterWheat_logtrend- mean(Yield_Covariates_ww_Mai$winterWheat_logtrend), main="Yield vs SMI")
...
plot(Yield_Covariates_ww_Mai$winterWheat ~ as.integer(Yield_Covariates_ww_Mai$year))
lineartrend <- lm(winterWheat ~ as.integer(year), data= Yield_Covariates_ww_Mai )
summary(lineartrend)
abline(lineartrend)
abline(453.5511,0, col="green")
length(resid(lineartrend))
Yield_Covariates_ww_Mai$winterWheat_lintren <- resid(lineartrend)

r=6
formula_Mai_ww_lintren  <- winterWheat_lintren ~ poly(Prec, degree[r, 1], raw = T) +  poly(Tavg, degree[r, 2], raw = T) + 
  dummy(SMI_GDM,c("severe drought","moderate drought","abnormal dry", "abnormal wet", "abundant wet","severe wet")) 

## Remove log trend ##
'Fit log of yield on log of time and use the residuals of that for yields'
plot(log(Yield_Covariates_ww_Mai$winterWheat) ~ log(as.integer(Yield_Covariates_ww_Mai$year)))
logtrend <- lm(log(winterWheat) ~ log(as.integer(year)), data= Yield_Covariates_ww_Mai)
abline(logtrend)
summary(logtrend)
...
r=6
formula_Mai_ww_detrendlog <- winterWheat_logtrend ~ poly(Prec, degree[r, 1], raw = T) +  poly(Tavg, degree[r, 2], raw = T) + 
  dummy(SMI_GDM,c("severe drought","moderate drought","abnormal dry", "abnormal wet", "abundant wet","severe wet")) 
...
for(r in 1:9){
  glm.fit_logdetrend <- glm(formula= update(formula_Mai_ww_detrendlog, .~. + dummy(comId)),  data = Yield_Covariates_ww_Mai) 
...
## PLM Ergebnisse ##
r = r_logdetrend
plm.fit_Mai_detrendlinear <- plm(formula= formula_Mai_ww_detrendlinear,  data = Yield_Covariates_ww_Mai, effect="individual", model="within")
plm.fit_Mai_detrendlog <- plm(formula= formula_Mai_ww_detrendlog,  data = Yield_Covariates_ww_Mai, effect="individual", model="within")
...
head(Yield_Covariates_ww_Mai)
Yield_Covariates_ww_Mai$yearshort <- as.integer(Yield_Covariates_ww_Mai$year) - 1999
...
#############################
## Plot SMI Pet ##
plot(Yield_Covariates_ww_Mai$winterWheat ~ Yield_Covariates_ww_Mai$Pet)
plot(Yield_Covariates_ww_Mai$winterWheat ~ Yield_Covariates_ww_Mai$Tavg)

## Determine formula
formula_Mai_ww_Pet <- log(winterWheat) ~ poly(Prec, degree[r, 1], raw = T) +  poly(Pet, degree[r, 2], raw = T) + 
  dummy(SMI_GDM,c("severe drought","moderate drought","abnormal dry", "abnormal wet", "abundant wet","severe wet")) + log(as.integer(year))
formula_Mai_ww_Pet_detrendlog <- winterWheat_logtrend ~ poly(Prec, degree[r, 1], raw = T) +  poly(Pet, degree[r, 2], raw = T) + 
  dummy(SMI_GDM,c("severe drought","moderate drought","abnormal dry", "abnormal wet", "abundant wet","severe wet")) 
...
for(r in 1:9){
  glm.fit_Pet <- glm(formula= update(formula_Mai_ww_Pet_detrendlog, .~. + dummy(comId)),  data = temp1) 
  BIC_Pet[r] <- BIC(glm.fit_Pet)
}
...
r_Pet = 4 
lm.fit_Pet <- lm(formula= update(formula_Mai_ww_Pet_detrendlog, .~. + dummy(comId)),  data = temp1) 
...
## PLM Ergebnisse ##
head(temp1)
plm.fit_Mai_Pet <- plm(formula= formula_Mai_ww_Pet,  data = temp1, effect="individual", model="within")
plm.fit_Mai_Pet_detrendlog <- plm(formula= formula_Mai_ww_Pet_detrendlog,  data = temp1, effect="individual", model="within")
