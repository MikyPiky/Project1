...
###################
## GLM Ergebniss ##
glm.fit_WW_bestStandard_Mar  <- glm(formula = bestStandard_formula,  data = Yield_Covariates_WW_Mar)
summary(glm.fit_WW_bestStandard_Mar)
'AIC: -7701.'

####################
## PLM Ergebnisse ##
plm.fit_WW_bestStandard_Mar <- plm(formula = update(bestStandard_formula, .~. - dummy(comId)),  data = Yield_Covariates_WW_Mar,  effect="individual", model=("within"), index = c("comId","year"))
summary(plm.fit_WW_bestStandard_Mar)
'Adj. R-Squared: 0.17301'

## Generate Fixed Effects data.frame and export it ##
fixef <- fixef(plm.fit_WW_bestStandard_Mar)
fixef <- as.data.frame(as.matrix(fixef))
head(fixef)
fixef <- cbind(rownames(fixef), fixef)
rownames(fixef) <- NULL
names(fixef) <- c("comId", "FE")
write.csv(fixef, "./figures/figures_exploratory/FixedEffects/Winterwheat/plm.fit_WW_bestStandard_Mar_FE.csv")

##################
## LM Ergebniss ##
lm.fit_WW_bestStandard_Mar  <-lm(formula = bestStandard_formula,  data = Yield_Covariates_WW_Mar)
summary(lm.fit_WW_bestStandard_Mar) 
'Adjusted R-squared:  0.7041'

########################
## Heteroskedasdicity ##
bptest(glm.fit_WW_bestStandard_Mar) # Breusch Pagan Test of Heteroskedastie in den Störgrößen: Null: Homoskedasdicity.
bptest(plm.fit_WW_bestStandard_Mar)
' In beiden Fällen kann die Null widerlegt werden. Es gibt also heteroskedasdicity '

## Koenkers Version on BP Test: robuste Modification wenn die Störgrößen nicht normalverteilt sind. 
bptest(plm.fit_WW_bestStandard_Mar, studentize = TRUE)
'Auch hier kann die Null widerlegt werden. Need to use robust covariance variance matrix to correct standard errors'
...
######################################
## Tests for serial autocorrelation ##
pwartest(plm.fit_WW_bestStandard_Mar)
' Hier serielle Korrelation festzustellen'
pbgtest(plm.fit_WW_bestStandard_Mar) 
...
## Correct Standard Errors used in table ##
coeftest(plm.fit_WW_bestStandard_Mar)

## Robust covariance matrix estimators a la White 
# coeftest(plm.fit_WW_bestStandard_Mar,vcov=vcovHC(plm.fit_WW_bestStandard_Mar,method = "arellano", type = "HC0")) 
cov0_WW_bestStandard_Mar <- vcovHC(plm.fit_WW_bestStandard_Mar,method = "arellano", type = "HC0", cluster="group")
Wh.se_serial_WW_bestStandard_Mar <- sqrt(diag(cov0_WW_bestStandard_Mar))

cov0.1_WW_bestStandard_Mar <- vcovHC(plm.fit_WW_bestStandard_Mar,method = "arellano", type = "HC0", cluster="time")
Wh.se_cross_WW_bestStandard_Mar <- sqrt(diag(cov0.1_WW_bestStandard_Mar))

# ## Beck Katz ##
# # coeftest(plm.fit_WW_bestStandard_Mar, vcov = function(x) vcovBK(plm.fit_WW_bestStandard_Mar,method = "arellano", type = "HC0"))
# cov1_WW_bestStandard_Mar <- vcovBK(plm.fit_WW_bestStandard_Mar,method = "arellano", type = "HC0",  cluster="time")
# BK.se_WW_bestStandard_Mar <- sqrt(diag(cov1_WW_bestStandard_Mar))

## Driscoll Kraay: ##
summary(plm.fit_WW_bestStandard_Mar)
cov2_WW_bestStandard_Mar     <- vcovSCC(plm.fit_WW_bestStandard_Mar,method = "arellano",type = "HC0")
DK.se_WW_bestStandard_Mar    <- sqrt(diag(cov2_WW_bestStandard_Mar))

# cov2.1_WW_bestStandard_Mar   <- vcovSCC(plm.fit_WW_bestStandard_Mar,method = "arellano",type = "HC0", maxlag=1)
# DK2.1.se_WW_bestStandard_Mar <- sqrt(diag(cov2.1_WW_bestStandard_Mar))

# cov2.2_WW_bestStandard_Mar   <- vcovSCC(plm.fit_WW_bestStandard_Mar,method = "arellano",type = "HC0", maxlag=2)
# DK2.2.se_WW_bestStandard_Mar <- sqrt(diag(cov2.2_WW_bestStandard_Mar))
# 
# cov2.3_WW_bestStandard_Mar   <- vcovSCC(plm.fit_WW_bestStandard_Mar,method = "arellano",type = "HC0", maxlag=3)
# DK2.3.se_WW_bestStandard_Mar <- sqrt(diag(cov2.3_WW_bestStandard_Mar))
# 
# cov2.4_WW_bestStandard_Mar   <- vcovSCC(plm.fit_WW_bestStandard_Mar,method = "arellano",type = "HC0", maxlag=4)
# DK2.4.se_WW_bestStandard_Mar <- sqrt(diag(cov2.4_WW_bestStandard_Mar))
# 
cov2.5_WW_bestStandard_Mar   <- vcovSCC(plm.fit_WW_bestStandard_Mar,method = "arellano",type = "HC0", maxlag=5)
DK2.5.se_WW_bestStandard_Mar <- sqrt(diag(cov2.5_WW_bestStandard_Mar))

## Cameron et al /Thompson : doouble-clustering estimator 
# coeftest(plm.fit_WW_bestStandard_Mar, vcovDC(plm.fit_WW_bestStandard_Mar, method = "arellano", type = "HC0"))
cov3_WW_bestStandard_Mar <- vcovDC(plm.fit_WW_bestStandard_Mar, method = "arellano", type = "HC0")
CT.se_WW_bestStandard_Mar <- sqrt(diag(cov3_WW_bestStandard_Mar))
'Our estimator is qualitatively similar to the ones presented in White and Domowitz (1984), for
time series data, and Conley (1999), for spatial data. '

## Generate Table with Output ##
se <- list(NULL, Wh.se_cross_WW_bestStandard_Mar, Wh.se_serial_WW_bestStandard_Mar, DK.se_WW_bestStandard_Mar, DK2.5.se_WW_bestStandard_Mar, CT.se_WW_bestStandard_Mar)
labels1 <-c("NULL","WhiteCross","WhiteSerial", "DriscollKraay", "DriscollKray2.5","CameronThompson")
stargazer(plm.fit_WW_bestStandard_Mar, plm.fit_WW_bestStandard_Mar, plm.fit_WW_bestStandard_Mar, plm.fit_WW_bestStandard_Mar, plm.fit_WW_bestStandard_Mar,plm.fit_WW_bestStandard_Mar,
          se = se,   
          dep.var.caption  = "Model with smallest BIC of Standard Configuration - March",
          dep.var.labels = "log(Winterwheat)",
          style="default",
          model.numbers = FALSE,
          column.labels = labels1,          
...
which.min(BIC_SMIPrecTavg) 
r = 9
bestSMI_formula <- formula_Mar_WW_detrendlog_SMIPrecTavg

###################
## GLM Ergebniss ##
glm.fit_WW_bestSMI_Mar  <- glm(formula = bestSMI_formula,  data = Yield_Covariates_WW_Mar)
summary(glm.fit_WW_bestSMI_Mar)
'AIC: -7701.1'

####################
## PLM Ergebnisse ##
plm.fit_WW_bestSMI_Mar <- plm(formula = update(bestSMI_formula, .~. - dummy(comId)),  data = Yield_Covariates_WW_Mar,  effect="individual", model=("within"), index = c("comId","year"))
summary(plm.fit_WW_bestSMI_Mar)
'Adj. R-Squared: 0.17301'

fixef <- fixef(plm.fit_WW_bestSMI_Mar)
fixef <- as.data.frame(as.matrix(fixef))
head(fixef)
fixef <- cbind(rownames(fixef), fixef)
rownames(fixef) <- NULL
names(fixef) <- c("comId", "FE")
write.csv(fixef, "./figures/figures_exploratory/FixedEffects/Winterwheat/plm.fit_WW_bestSMI_Mar_FE.csv")

##################
## LM Ergebniss ##
lm.fit_WW_bestSMI_Mar  <-lm(formula = bestSMI_formula,  data = Yield_Covariates_WW_Mar)
summary(lm.fit_WW_bestSMI_Mar) 
'Adjusted R-squared:  0.7041'

########################
## Heteroskedasdicity ##
bptest(glm.fit_WW_bestSMI_Mar) # Breusch Pagan Test of Heteroskedastie in den Störgrößen: Null: Homoskedasdicity.
bptest(plm.fit_WW_bestSMI_Mar)
' In beiden Fällen kann die Null widerlegt werden. Es gibt also heteroskedasdicity '

## Koenkers Version on BP Test: robuste Modification wenn die Störgrößen nicht normalverteilt sind. 
bptest(plm.fit_WW_bestSMI_Mar, studentize = TRUE)
'Auch hier kann die Null widerlegt werden. Need to use robust covariance variance matrix to correct standard errors'
...
######################################
## Tests for serial autocorrelation ##
pwartest(plm.fit_WW_bestSMI_Mar)
pbgtest(plm.fit_WW_bestSMI_Mar) 
'Hier serielle Korrelation festzustellen'

###########################################
## Correct Standard Errors used in table ##
coeftest(plm.fit_WW_bestSMI_Mar)

## Robust covariance matrix estimators a la White ##
# coeftest(plm.fit_WW_bestSMI_Mar,vcov=vcovHC(plm.fit_WW_bestSMI_Mar,method = "arellano", type = "HC0")) 
cov0_WW_bestSMI_Mar <- vcovHC(plm.fit_WW_bestSMI_Mar,method = "arellano", type = "HC0", cluster="group")
Wh.se_serial_WW_bestSMI_Mar <- sqrt(diag(cov0_WW_bestSMI_Mar))

cov0.1_WW_bestSMI_Mar <- vcovHC(plm.fit_WW_bestSMI_Mar,method = "arellano", type = "HC0", cluster="time")
Wh.se_cross_WW_bestSMI_Mar <- sqrt(diag(cov0.1_WW_bestSMI_Mar))

## Driscoll Kraay ##
# summary(plm.fit_WW_bestSMI_Mar)
cov2_WW_bestSMI_Mar     <- vcovSCC(plm.fit_WW_bestSMI_Mar,method = "arellano",type = "HC0")
DK.se_WW_bestSMI_Mar    <- sqrt(diag(cov2_WW_bestSMI_Mar))

# cov2.1_WW_bestSMI_Mar   <- vcovSCC(plm.fit_WW_bestSMI_Mar,method = "arellano",type = "HC0", maxlag=1)
# DK2.1.se_WW_bestSMI_Mar <- sqrt(diag(cov2.1_WW_bestSMI_Mar))
# cov2.2_WW_bestSMI_Mar   <- vcovSCC(plm.fit_WW_bestSMI_Mar,method = "arellano",type = "HC0", maxlag=2)
# DK2.2.se_WW_bestSMI_Mar <- sqrt(diag(cov2.2_WW_bestSMI_Mar))
# cov2.3_WW_bestSMI_Mar   <- vcovSCC(plm.fit_WW_bestSMI_Mar,method = "arellano",type = "HC0", maxlag=3)
# DK2.3.se_WW_bestSMI_Mar <- sqrt(diag(cov2.3_WW_bestSMI_Mar))
# cov2.4_WW_bestSMI_Mar   <- vcovSCC(plm.fit_WW_bestSMI_Mar,method = "arellano",type = "HC0", maxlag=4)
# DK2.4.se_WW_bestSMI_Mar <- sqrt(diag(cov2.4_WW_bestSMI_Mar))

cov2.5_WW_bestSMI_Mar   <- vcovSCC(plm.fit_WW_bestSMI_Mar,method = "arellano",type = "HC0", maxlag=5)
DK2.5.se_WW_bestSMI_Mar <- sqrt(diag(cov2.5_WW_bestSMI_Mar))


## Cameron et al /Thompson : doouble-clustering estimator ##
cov3_WW_bestSMI_Mar <- vcovDC(plm.fit_WW_bestSMI_Mar, method = "arellano", type = "HC0")
CT.se_WW_bestSMI_Mar <- sqrt(diag(cov3_WW_bestSMI_Mar))

################################
## Generate Table with Output ##
se <- list(NULL, Wh.se_cross_WW_bestSMI_Mar, Wh.se_serial_WW_bestSMI_Mar,  DK.se_WW_bestSMI_Mar, DK2.5.se_WW_bestSMI_Mar, CT.se_WW_bestSMI_Mar)
labels1 <-c("NULL","WhiteCross","WhiteSerial", "DriscollKraay", "DriscollKray2.5","CameronThompson")
stargazer(plm.fit_WW_bestSMI_Mar, plm.fit_WW_bestSMI_Mar, plm.fit_WW_bestSMI_Mar, plm.fit_WW_bestSMI_Mar, plm.fit_WW_bestSMI_Mar,plm.fit_WW_bestSMI_Mar,
          se = se,   
          dep.var.caption  = "Model with smallest BIC with SMI - March",
          dep.var.labels = "log(Winterwheat)",
          style="default",
          model.numbers = FALSE,
          column.labels = labels1,          
