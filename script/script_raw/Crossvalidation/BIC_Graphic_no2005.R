...
## October_lag no 2005 ##
BIC_WW_10lag_no2005 <- read.csv("./data/data_raw/BIC/BIC_WW_Oct_lag_no2005.csv")
BIC_WW_10lag_no2005$index <-  rep(1:55)


which.min(BIC_WW_10lag_no2005$BIC)
BIC_WW_10lag_no2005_mintot <- BIC_WW_10lag_no2005[which.min(BIC_WW_10lag_no2005$BIC),]

g10lag_WW <- ggplot(BIC_WW_10lag_no2005,aes(y=BIC, x=index, color = model))
g10lag_WW + labs(title="BIC of various model configurations - no2005", x="") +    
  geom_point(size=10) +     
  theme_few() +  scale_colour_brewer(type = "qual", palette = "Paired", direction = "1") + 
  ...
  geom_vline(xintercept = 18.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_vline(xintercept = 37.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_point(data=BIC_WW_10lag_no2005_mintot, colour=colors11[1], size=20)
...
#########################
## November_lag no2005 ##
BIC_WW_11lag_no2005 <- read.csv("./data/data_raw/BIC/BIC_WW_Nov_lag_no2005.csv")
levels(BIC_WW_11lag_no2005$month) <- "November_lag_no2005"
BIC_WW_11lag_no2005$index <-  rep(1:55)
head(BIC_WW_11lag_no2005)

which.min(BIC_WW_11lag_no2005$BIC)
BIC_WW_11lag_no2005_mintot <- BIC_WW_11lag_no2005[which.min(BIC_WW_11lag_no2005$BIC),]

g11lag_no2005_WW <- ggplot(BIC_WW_11lag_no2005,aes(y=BIC, x=index, color = model))
g11lag_no2005_WW + labs(title="BIC of various model configurations", x="") +    
  geom_point(size=10) +     
  theme_few() +  scale_colour_brewer(type = "qual", palette = "Paired", direction = "1") + 
  theme(plot.title=element_blank(), 
        panel.grid.major.x = element_blank(),
  ...
  geom_vline(xintercept = 18.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_vline(xintercept = 37.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_point(data=BIC_WW_11lag_no2005_mintot, colour=colors20[2], size=20)
...
## December_lag no2005##
BIC_WW_12lag_no2005 <- read.csv("./data/data_raw/BIC/BIC_WW_Dec_lag_no2005.csv")
BIC_WW_12lag_no2005$index <-  rep(1:55)
head(BIC_WW_12lag_no2005)

which.min(BIC_WW_12lag_no2005$BIC)
BIC_WW_12lag_no2005_mintot <- BIC_WW_12lag_no2005[which.min(BIC_WW_12lag_no2005$BIC),]

g12lag_WW <- ggplot(BIC_WW_12lag_no2005,aes(y=BIC, x=index, color = model))
g12lag_WW + labs(title="BIC of various model configurations", x="") +    
  geom_point(size=10) +     
  theme_few() +  scale_colour_brewer(type = "qual", palette = "Paired", direction = "1") + 
  theme(plot.title=element_blank(), 
  ...
  geom_vline(xintercept = 18.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_vline(xintercept = 37.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_point(data=BIC_WW_12lag_no2005_mintot, colour=colors11[1], size=20)
...
####################################################################################################################################################################
## January no 2005 ##
BIC_WW_1_no2005 <- read.csv("./data/data_raw/BIC/BIC_WW_Jan_no2005.csv")
BIC_WW_1_no2005$index <-  rep(1:55)

which.min(BIC_WW_1_no2005$BIC)
BIC_WW_1_no2005_mintot <- BIC_WW_1_no2005[which.min(BIC_WW_1_no2005$BIC),]

g1_no2005_WW <- ggplot(BIC_WW_1_no2005,aes(y=BIC, x=index, color = model))
g1_no2005_WW + labs(title="BIC of various model configurations", x="") +    
  geom_point(size=10) +     
  theme_few() +  scale_colour_brewer(type = "qual", palette = "Paired", direction = "1") + 
  theme(plot.title=element_blank(), 
        panel.grid.major.x = element_blank(),
  ...
  geom_vline(xintercept = 18.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_vline(xintercept = 37.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_point(data=BIC_WW_1_no2005_mintot, colour=colors11[1], size=20)
...
## February - no2005 ##
BIC_WW_2_no2005 <- read.csv("./data/data_raw/BIC/BIC_WW_Feb_no2005.csv")
levels(BIC_WW_2_no2005$month) <- "February_no2005"
BIC_WW_2_no2005$index <-  rep(1:55)
which.min(BIC_WW_2_no2005$BIC)
BIC_WW_2_no2005_mintot <- BIC_WW_2_no2005[which.min(BIC_WW_2_no2005$BIC),]

g2_WW <- ggplot(BIC_WW_2_no2005,aes(y=BIC, x=index, color = model))
g2_WW + labs(title="BIC of various model configurations", x="") +    
  geom_point(size=10) +     
  theme_few() +  scale_colour_brewer(type = "qual", palette = "Paired", direction = 1) + 
  theme(plot.title=element_blank(), 
  ...
  geom_vline(xintercept = 18.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_vline(xintercept = 37.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_point(data=BIC_WW_2_no2005_mintot, colour=colors11[1], size=20)
...
## March no 2005 ##
BIC_WW_3_no2005 <- read.csv("./data/data_raw/BIC/BIC_WW_Mar_no2005.csv")
BIC_WW_3_no2005$index <-  rep(1:55)
which.min(BIC_WW_3_no2005$BIC)
BIC_WW_3_no2005_mintot <- BIC_WW_3_no2005[which.min(BIC_WW_3_no2005$BIC),]

g3_WW_no2005 <- ggplot(BIC_WW_3_no2005,aes(y=BIC, x=index, color = model))
g3_WW_no2005 + labs(title="BIC of various model configurations", x="") +  
  geom_point(size=10) +     
  theme_few() +  scale_colour_brewer(type = "qual", palette = "Paired", direction = "1") + 
  theme(plot.title=element_blank(), 
        panel.grid.major.x = element_blank(),
  ...
  geom_vline(xintercept = 18.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_vline(xintercept = 37.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_point(data=BIC_WW_3_no2005_mintot,  size=20)
...
## April no 2005 ##
BIC_WW_4_no2005 <- read.csv("./data/data_raw/BIC/BIC_WW_Apr_no2005.csv")
BIC_WW_4_no2005$index <-  rep(1:55)
which.min(BIC_WW_4_no2005$BIC)
BIC_WW_4_no2005_mintot <- BIC_WW_4_no2005[which.min(BIC_WW_4_no2005$BIC),]

g4_WW_no2005 <- ggplot(BIC_WW_4_no2005,aes(y=BIC, x=index, color = model))
g4_WW_no2005 + labs(title="BIC of various model configurations", x="") +   
  geom_point(size=10) +     
  theme_few() +  scale_colour_brewer(type = "qual", palette = "Paired", direction = "1") + 
  theme(plot.title=element_blank(), 
        panel.grid.major.x = element_blank(),
  ...
  geom_vline(xintercept = 18.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_vline(xintercept = 37.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_point(data=BIC_WW_4_no2005_mintot,  size=20)
...
## Mai - no 2005 ##
BIC_WW_5_no2005 <- read.csv("./data/data_raw/BIC/BIC_WW_May_no2005.csv")
BIC_WW_5_no2005$index <-  rep(1:55)
which.min(BIC_WW_5_no2005$BIC)
BIC_WW_5_no2005_mintot <- BIC_WW_5_no2005[which.min(BIC_WW_5_no2005$BIC),]

g5_WW_no2005 <- ggplot(BIC_WW_5_no2005,aes(y=BIC, x=index, color = model))
g5_WW_no2005 + labs(title="BIC of various model configurations", x="") +
  geom_point(size=10) +     
  theme_few() +  scale_colour_brewer(type = "qual", palette = "Paired", direction = "1") + 
  theme(plot.title=element_blank(), 
        panel.grid.major.x = element_blank(),
  ...
  geom_vline(xintercept = 18.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_vline(xintercept = 37.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_point(data=BIC_WW_5_no2005_mintot,  size=20)
...
head(BIC_WW_6)
head(BIC_WW_6_no2005)


## June no 2005 ##
BIC_WW_6_no2005 <- read.csv("./data/data_raw/BIC/BIC_WW_Jun_no2005.csv")
head(BIC_WW_6_no2005)
BIC_WW_6_no2005$index <-  rep(1:55)

head(BIC_WW_6_no2005)
which.min(BIC_WW_6_no2005$BIC)
BIC_WW_6_no2005_mintot <- BIC_WW_6_no2005[which.min(BIC_WW_6_no2005$BIC),]

g6_WW_no2005 <- ggplot(BIC_WW_6_no2005,aes(y=BIC, x=index, color = model))
g6_WW_no2005 + labs(title="BIC of various model configurations - June no2005", x="") +   
  geom_point(size=10) +     
  theme_few() +  scale_colour_brewer(type = "qual", palette = "Paired", direction = "1") + 
  theme(
#     plot.title=element_blank(), 
  ...
  geom_vline(xintercept = 18.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_vline(xintercept = 37.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_point(data=BIC_WW_6_no2005_mintot,  size=20)
...
## July - no2005 ##
BIC_WW_7_no2005 <- read.csv("./data/data_raw/BIC/BIC_WW_Jul_no2005.csv")
BIC_WW_7_no2005$index <-  rep(1:55)
which.min(BIC_WW_7_no2005$BIC)
BIC_WW_7_no2005_mintot <- BIC_WW_7_no2005[which.min(BIC_WW_7_no2005$BIC),]

g7_WW_no2005 <- ggplot(BIC_WW_7_no2005,aes(y=BIC, x=index, color = model))
g7_WW_no2005 + labs(title="BIC of various model configurations", x="") +
  geom_point(size=10) +     
  theme_few() +  scale_colour_brewer(type = "qual", palette = "Paired", direction = "1") + 
  theme(plot.title=element_blank(), 
        panel.grid.major.x = element_blank(),
  ...
  geom_vline(xintercept = 18.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_vline(xintercept = 37.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_point(data=BIC_WW_7_no2005_mintot, size=20)
...
## August - no2005##
BIC_WW_8_no2005 <- read.csv("./data/data_raw/BIC/BIC_WW_Aug_no2005.csv")
BIC_WW_8_no2005$index <-  rep(1:55)
which.min(BIC_WW_8_no2005$BIC)
BIC_WW_8_no2005_mintot <- BIC_WW_8_no2005[which.min(BIC_WW_8_no2005$BIC),]

g8_WW_no2005 <- ggplot(BIC_WW_8_no2005,aes(y=BIC, x=index,color=model)) + geom_point() 
g8_WW_no2005 + labs(title="BIC of various model configurations", x="") +
  geom_point(size=10) +     
  theme_few() +  scale_colour_brewer(type = "qual", palette = "Paired", direction = "1") + 
  theme(plot.title=element_blank(), 
        panel.grid.major.x = element_blank(),
  ...
  geom_vline(xintercept = 18.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_vline(xintercept = 37.5,  colour="grey", linetype = "longdash", size=0.5) +
  geom_point(data=BIC_WW_8_no2005_mintot,  size=20)
...
#BIC_WW_10lag_mintot,BIC_WW_11lag_no2005_mintot, BIC_WW_12lag_mintot, BIC_WW_1_mintot, 
levels(BIC_WW$month)[levels(BIC_WW$month)=="Mai"] <- "May"
head(BIC_WW)
BIC_WW_mintot <- as.data.frame(rbind( BIC_WW_2_mintot, BIC_WW_3_mintot,BIC_WW_4_mintot, BIC_WW_5_mintot,BIC_WW_6_mintot, BIC_WW_7_mintot, BIC_WW_8_no2005_mintot))
BIC_WW_SMI <- as.data.frame(rbind(BIC_WW_10lag[28,],BIC_WW_11lag_no2005[28,],BIC_WW_12lag[28,],BIC_WW_1[28,],
...
####################
## Total -2005 vs no2005 ##
BIC_WW_2005_vs_no2005 <- as.data.frame(rbind(BIC_WW_10lag, BIC_WW_10lag_no2005,
                                     BIC_WW_11lag, BIC_WW_11lag_no2005,
                                     BIC_WW_12lag, BIC_WW_12lag_no2005,
                                     BIC_WW_1, BIC_WW_1_no2005, 
                                     BIC_WW_2, BIC_WW_2_no2005, 
                                     BIC_WW_3, BIC_WW_3_no2005, 
                                     BIC_WW_4, BIC_WW_4_no2005, 
                                     BIC_WW_5, BIC_WW_5_no2005, 
                                     BIC_WW_6, BIC_WW_6_no2005, 
                                     BIC_WW_7, BIC_WW_7_no2005, 
                                     BIC_WW_8, BIC_WW_8_no2005))

levels(BIC_WW_2005_vs_no2005$month)[levels(BIC_WW_2005_vs_no2005$month)=="Mai"] <- "May"

BIC_WW_mintot_2005_vs_no2005 <- as.data.frame(rbind( BIC_WW_10lag_mintot, BIC_WW_10lag_no2005_mintot,
                                      BIC_WW_11lag_mintot, BIC_WW_11lag_no2005_mintot,
                                      BIC_WW_12lag_mintot, BIC_WW_12lag_no2005_mintot, 
                                      BIC_WW_1_mintot,  BIC_WW_10lag_no2005_mintot,
                                      BIC_WW_2_mintot, BIC_WW_2_no2005_mintot, 
                                      BIC_WW_3_mintot, BIC_WW_3_no2005_mintot,
                                      BIC_WW_4_mintot, BIC_WW_4_no2005_mintot,
                                      BIC_WW_5_mintot, BIC_WW_5_no2005_mintot,
                                      BIC_WW_6_mintot, BIC_WW_6_no2005_mintot, 
                                      BIC_WW_7_mintot, BIC_WW_7_no2005_mintot, 
                                      BIC_WW_8_mintot, BIC_WW_8_no2005_mintot))

BIC_WW_SMI_2005_vs_no2005 <- as.data.frame(rbind(BIC_WW_10lag[28,], BIC_WW_10lag_no2005[28,],
                                         BIC_WW_11lag[28,], BIC_WW_11lag_no2005[28,],
                                         BIC_WW_12lag[28,], BIC_WW_12lag_no2005[28,],
                                         BIC_WW_1[28,], BIC_WW_1_no2005[28,], 
                                         BIC_WW_2[28,], BIC_WW_2_no2005[28,], 
                                         BIC_WW_3[28,], BIC_WW_3_no2005[28,], 
                                         BIC_WW_4[28,], BIC_WW_4_no2005[28,], 
                                         BIC_WW_5[28,], BIC_WW_5_no2005[28,],
                                         BIC_WW_6[28,], BIC_WW_6_no2005[28,],
                                         BIC_WW_7[28,], BIC_WW_7_no2005[28,],
                                         BIC_WW_8[28,],  BIC_WW_8_no2005[28,]))



g_WW_2005_vs_no2005 <- ggplot(BIC_WW_2005_vs_no2005 ,aes(y=BIC, x=model_index,color=model))
g_WW_2005_vs_no2005 + labs(title="BIC of various model configurations - Winter Wheat", x="") +
  geom_point(size=2, alpha=0.0001) +     theme_few() +
  #       geom_jitter(size=10) +  # scale_colour_brewer(type = "qual", palette = "Paired", direction = "-1") + 
  #    geom_point(size=4, alpha=1) +
  #   geom_violin(size=2.5) +
  ...
  geom_vline(xintercept = 2.5,  colour="grey", linetype = "longdash", size=0.3) +
  geom_vline(xintercept = 9.5,  colour="grey", linetype = "longdash", size=0.3)  
  geom_point(data=BIC_WW_mintot_2005_vs_no2005, colour="black", size=2)

#####################
## Total - no 2005 ##
BIC_WW_no2005 <- as.data.frame(rbind( BIC_WW_10lag_no2005,
                                             BIC_WW_11lag_no2005,
                                             BIC_WW_12lag_no2005,
                                             BIC_WW_1_no2005, 
                                             BIC_WW_2_no2005, 
...
levels(BIC_WW_2005$month)[levels(BIC_WW_2005$month)=="Mai"] <- "May"

BIC_WW_mintot_no2005 <- as.data.frame(rbind(BIC_WW_10lag_no2005_mintot,
                                           BIC_WW_11lag_no2005_mintot,
                                           BIC_WW_12lag_no2005_mintot, 
                                           BIC_WW_10lag_no2005_mintot,
                                           BIC_WW_2_no2005_mintot, 
                                           BIC_WW_3_no2005_mintot,
                                           BIC_WW_4_no2005_mintot,
                                           BIC_WW_5_no2005_mintot,
                                           BIC_WW_6_no2005_mintot, 
                                           BIC_WW_7_no2005_mintot, 
                                           BIC_WW_8_no2005_mintot))

BIC_WW_SMI_no2005 <- as.data.frame(rbind(BIC_WW_10lag_no2005[28,],
                                        BIC_WW_11lag_no2005[28,],
                                        BIC_WW_12lag_no2005[28,],
                                        BIC_WW_1_no2005[28,], 
                                        BIC_WW_2_no2005[28,], 
                                        BIC_WW_3_no2005[28,], 
                                        BIC_WW_4_no2005[28,], 
...
g_WW_2005_no2005 <- ggplot(BIC_WW_no2005,aes(y=BIC, x=model_index,color=model))
g_WW_2005_no2005 + labs(title="BIC of various model configurations - Winter Wheat", x="") +
  geom_point(size=2, alpha=0.0001) +     theme_few() +
  #       geom_jitter(size=10) +  # scale_colour_brewer(type = "qual", palette = "Paired", direction = "-1") + 
  #    geom_point(size=4, alpha=1) +
  #   geom_violin(size=2.5) +
  ...
  geom_vline(xintercept = 2.5,  colour="grey", linetype = "longdash", size=0.3) +
  geom_vline(xintercept = 9.5,  colour="grey", linetype = "longdash", size=0.3)  
# geom_point(data=BIC_WW_mintot_2005, colour="black", size=2)
