...
##########################
## Best Standard Models ##
se_bestStandard2_no2005 <- list(DK.se_WW_bestStandard_Oct_lag_no2005, 
                                DK.se_WW_bestStandard_Nov_lag_no2005, 
                                DK.se_WW_BEST_Dec_lag_no2005, 
                                DK.se_WW_BEST_Jan_no2005, 
                                DK.se_WW_BEST_Feb_no2005, 
                                DK.se_WW_bestStandard_Mar_no2005, 
                                DK.se_WW_BEST_Apr_no2005, 
                                DK.se_WW_bestStandard_May_no2005, 
                                DK.se_WW_BEST_Jun_no2005, 
                                DK.se_WW_bestStandard_Jul_no2005,
                                DK.se_WW_BEST_Aug_no2005)
