...
#################
## Best Models ##
se_BEST_no2005 <- list(DK.se_WW_BEST_Oct_lag_no2005, DK.se_WW_BEST_Nov_lag_no2005, DK.se_WW_BEST_Dec_lag_no2005, 
                DK.se_WW_BEST_Jan_no2005 ,DK.se_WW_BEST_Feb_no2005, DK.se_WW_BEST_Mar_no2005, DK.se_WW_BEST_Apr_no2005, 
                       DK.se_WW_BEST_May_no2005, DK.se_WW_BEST_Jun_no2005, DK.se_WW_BEST_Jul_no2005,
                       DK.se_WW_BEST_Aug_no2005)

cov.labels1_no2005 <-c("Prec$^{1}$", "Prec$^{2}$", "Prec$^{3}$", 
                        "Prec",
                         "T$^{1}$", "T$^{2}$", "T$^{3}$"    ,
                       "Pet$^{1}$", "Pet$^{2}$", "Pet$^{3}$", 
                        "SMI:sev. drought", "SMI:mod. drought",  "SMI:abn. dry", "SMI:abn. wet", 
  "SMI:abun. wet", "SMI:sev. wet" )
labels1_no2005 <-c("October", "November", "December", "January", "February","March","April","May", "June","July","August")

stargazer(plm.fit_WW_BEST_Oct_lag_no2005, plm.fit_WW_BEST_Nov_lag_no2005, plm.fit_WW_BEST_Dec_lag_no2005, 
          plm.fit_WW_BEST_Jan_no2005, plm.fit_WW_BEST_Feb_no2005,plm.fit_WW_BEST_Mar_no2005,plm.fit_WW_BEST_Apr_no2005,
          plm.fit_WW_BEST_May_no2005,plm.fit_WW_BEST_Jun_no2005, plm.fit_WW_BEST_Jul_no2005, 
          plm.fit_WW_BEST_Aug_no2005, 
          se = se_BEST_no2005,  
          title  = "Results of Regression Models of Winter Wheat with smallest BIC - not considering 2005",
          dep.var.caption = "Dependent Variable: log(Winter Wheat)",
          dep.var.labels = "Model of the month",
         align=TRUE, 
          model.numbers = FALSE,
          column.labels = labels1_no2005,      
              covariate.labels = cov.labels1_no2005,          
          no.space=TRUE ,
          df = FALSE,
          type="text", 
          out="./figures/figures_exploratory/BIC/Winterwheat/WW_Best_no2005.txt"
#                      out="./figures/figures_exploratory/BIC/Winterwheat/WW_Best_no2005"
)
summary(plm.fit_WW_BEST_Mar_no2005)

##########################
## Best Standard Models ##
se_bestStandard2_no2005 <- list(DK.se_WW_BEST_Oct_lag_no2005, 
                                DK.se_WW_bestStandard_Nov_lag_no2005, 
                                DK.se_WW_BEST_Dec_lag_no2005, 
                                DK.se_WW_BEST_Jan_no2005, 
                                DK.se_WW_BEST_Feb_no2005, 
                                DK.se_WW_BEST_Mar_no2005, 
                                DK.se_WW_BEST_Apr_no2005, 
                                DK.se_WW_BEST_May_no2005, 
                                DK.se_WW_BEST_Jun_no2005, 
                                DK.se_WW_BEST_Jul_no2005,
                                DK.se_WW_BEST_Aug_no2005)

cov.labels2_no2005 <-c("Prec$^{1}$", "Prec$^{2}$",
                       "Prec$^{3}$",
                       "Prec",
                       "T$^{1}$", "T$^{2}$", "T$^{3}$"    ,
                ...
                "SMI:sev. drought", "SMI:mod. drought",  "SMI:abn. dry", "SMI:abn. wet", 
                "SMI:abun. wet", "SMI:sev. wet" )
labels2_no2005 <-c("October", "November", "December", "January", "February","March","April","May", "June","July","August")

stargazer(plm.fit_WW_BEST_Oct_lag_no2005, 
          plm.fit_WW_bestStandard_Nov_lag_no2005, 
          plm.fit_WW_BEST_Dec_lag_no2005, 
          plm.fit_WW_BEST_Jan_no2005, 
          plm.fit_WW_BEST_Feb_no2005, 
          plm.fit_WW_BEST_Mar_no2005, 
          plm.fit_WW_BEST_Apr_no2005,
          plm.fit_WW_BEST_May_no2005, 
          plm.fit_WW_BEST_Jun_no2005, 
          plm.fit_WW_BEST_Jul_no2005, 
          plm.fit_WW_BEST_Aug_no2005, 
          se = se_bestStandard2_no2005,  
          title  = "Results of Regression Models of Winter Wheat with smallest BIC of Standard Configuration - no2005",
          dep.var.caption = "Dependent Variable: log(Silomaize)",
#           dep.var.labels = "Model of the month",
          align=TRUE, 
          model.numbers = FALSE,
          column.labels = labels2_no2005,      
          covariate.labels = cov.labels2_no2005,          
          no.space=TRUE ,
          df = FALSE,
#                     type="text", 
#                     out="./figures/figures_exploratory/BIC/Winterwheat/WW_BestStandard_no2005.txt"
           out="./figures/figures_exploratory/BIC/Winterwheat/WW_BestStandard_no2005"
)

summary(plm.fit_WW_bestStandard_Mar_no2005)
##################################################################
## Plot with significant Coefficients of Standard Configuration ##
