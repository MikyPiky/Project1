...
names(Yield_Covariates_SM_Mai) <- c( "comId" , "year","com","comIdState","comState","SHAPE_AREA","siloMaize","SMI", "Prec","Tavg", "Pet" , "Tmin"   
                                     ,"Tmax", "SMI_GDM")
names(Yield_Covariates_SM_Mai)
