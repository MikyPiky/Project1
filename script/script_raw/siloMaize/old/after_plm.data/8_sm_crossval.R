...
formula_PrecTavgSmiGDM_2v3poly <- log(siloMaize) ~ poly(Prec_Aug, container_2v3poly[r, 1], raw = T) +  poly(Tavg_Aug, container_2v3poly[r, 2], raw = T) + 
...
for(r in 1:9){
  ...
  save.image(file = "/home/peichl/projects/crossvalid/siloMaize/cross8.RData")
}
