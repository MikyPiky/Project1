...
plot(Yield_Covariates_nna$SMI_Sep_GDM)
...
formula_PrecTavgSmiGDM_2v3poly<- log(siloMaize) ~ poly(Prec_Sep, container_2v3poly[r, 1], raw = T) +  poly(Tavg_Sep, container_2v3poly[r, 2], raw = T) + 
...
for(r in 1:9){
  ...
  save.image(file = "/home/peichl/projects/crossvalid/siloMaize/cross9.RData")
}
