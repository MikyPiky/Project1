...
head(Yield_Covariates_SM_Mai_nna)
...
Yield_Covariates_SM_Mai[1317,]
Yield_Covariates_SM_Mai[771,]
Yield_Covariates_SM_Mai[847,]
## Look at other values of outliers com #
Yield_Covariates_SM_Mai[Yield_Covariates_SM_Mai$comId == "5315",] # Köln Stadt: Nehme ich insgesamt raus; wenig Beobachtungen anyway
Yield_Covariates_SM_Mai[Yield_Covariates_SM_Mai$comId == "5378",] # Rheinisch Bergischer Kreis: Nehme ich insgesamt raus, wegen wenig Beonachtungen und starkt Variabilität
Yield_Covariates_SM_Mai[Yield_Covariates_SM_Mai$comId == "6532",] # hier scheint nur ein Jahr ein Messfehler zu sein: diesen Lösche ich 

## Delete outliers ##
Yield_Covariates_SM_Mai <- Yield_Covariates_SM_Mai[!(Yield_Covariates_SM_Mai$comId == "6532" & Yield_Covariates_SM_Mai$year == "2008"),]

## Delete dubious administrative districts ##
dim(Yield_Covariates_SM_Mai)
Yield_Covariates_SM_Mai <- Yield_Covariates_SM_Mai[!Yield_Covariates_SM_Mai$comId == "5378",] # Rheinisch Bergischer Kreis
dim(Yield_Covariates_SM_Mai)
Yield_Covariates_SM_Mai <- Yield_Covariates_SM_Mai[!Yield_Covariates_SM_Mai$comId == "5315",] # Köln
dim(Yield_Covariates_SM_Mai)

Yield_Covariates_SM_Mai <- na.omit(Yield_Covariates_SM_Mai)
rownames(Yield_Covariates_SM_Mai) <- NULL

## Estimate logtrend again ##
logtrend2 <- lm(log(siloMaize) ~ log(as.integer(year)), data= Yield_Covariates_SM_Mai)
plot(logtrend2, which=c(1:6)) 
## Show outliers
Yield_Covariates_SM_Mai[3217,] # Cottbus 
Yield_Covariates_SM_Mai[3229,] # Barnim
Yield_Covariates_SM_Mai[3516,] # Parchim

Yield_Covariates_SM_Mai[Yield_Covariates_SM_Mai$comId == "12052",] # Cottbus, mehme ich auch raus, da wenige Beobachtungen
Yield_Covariates_SM_Mai[Yield_Covariates_SM_Mai$comId == "12060",] # Barnim, hier nehme ich nur die Beobachtung 
Yield_Covariates_SM_Mai[Yield_Covariates_SM_Mai$comId == "13060",] # Parchim, hier nehme ich nur die Beobachtung 

## Delete dubious Adminstrative Districtive Cottbus ## 
Yield_Covariates_SM_Mai <- Yield_Covariates_SM_Mai[!Yield_Covariates_SM_Mai$comId == "12052",] # Cottbus
## Delete outliers observarion Barnim, 1999 ##
Yield_Covariates_SM_Mai <- Yield_Covariates_SM_Mai[!(Yield_Covariates_SM_Mai$comId == "12060" & Yield_Covariates_SM_Mai$year == "1999"),]
Yield_Covariates_SM_Mai <- Yield_Covariates_SM_Mai[!(Yield_Covariates_SM_Mai$comId == "13060" & Yield_Covariates_SM_Mai$year == "2010"),]
...
#############################
## Estimate logtrend again ##
logtrend3 <- lm(log(siloMaize) ~ log(as.integer(year)), data= Yield_Covariates_SM_Mai)
plot(logtrend3, which=c(1:6)) 
...
abline(logtrend3, col="green")
Yield_Covariates_SM_Mai$siloMaize_logtrend <- resid(logtrend3)
...
formula_Mai_sm_detrendlog_SMIPet <- siloMaize_logtrend ~ poly(Pet, degree[r, 1], raw = T) +  
  dummy(SMI_GDM,c("severe drought","moderate drought","abnormal dry", "abnormal wet", "abundant wet","severe wet")) + dummy(comId)
...
formula_Mai_sm_detrendlog_Pet <- siloMaize_logtrend ~ poly(Pet, degree[r, 1], raw = T)  + dummy(comId)
...
for(r in 1:9){  
  ...
  BIC_SMIPrec[r] <- BIC(glm.fit_Prec)
}
...
#   cv.error[r] <- cv.glm( Yield_Covariates_SM_Mai, glm.fit )$delta[1] # hat funktioniert (dummies dürfen nicht nur als Faktor definiert werden)
...
# cv.error_loocv_Mai_SiloMaize <- cv.error
...
glm.fit2 <- glm(formula = formula_Mai_sm_detrendlog,  data =  Yield_Covariates_SM_Mai, na.action=na.omit) 
'Caveat: Hier werden aufgrund von singulariät eine Menge NAs in den Fixed Effekten produziert.
 DIe NAs sind oft Deckungsgleich mit comIds mit nur wenigen Beobachtungen.'
...
hist(Yield_Covariates_SM_Mai$siloMaize)

## Relevant Values in plot
Yield_Covariates_SM_Mai[3219,]
Yield_Covariates_SM_Mai[3681,]
Yield_Covariates_SM_Mai[688,]
Yield_Covariates_SM_Mai[3335,]
Yield_Covariates_SM_Mai[3673,]


## Leverage one ##
# Warnings in plot()
Yield_Covariates_SM_Mai[c(181, 182, 765, 851, 1006, 1557) ,]

# Crucial Observations in plot()
Yield_Covariates_SM_Mai[c(3335,3673,3219, 3681, 1557),]
...
Yield_Covariates_SM_Mai[Yield_Covariates_SM_Mai$comId == "3101",] # < 1 Beobachtung
Yield_Covariates_SM_Mai[Yield_Covariates_SM_Mai$comId == "3102",] # # < 1 Beobachtung
Yield_Covariates_SM_Mai[Yield_Covariates_SM_Mai$comId == "5314",] # < 1 Beobachtung 
Yield_Covariates_SM_Mai[Yield_Covariates_SM_Mai$comId == "5512",] # < 1 Beobachtung
Yield_Covariates_SM_Mai[Yield_Covariates_SM_Mai$comId == "5911",] # < 1 Beobachtung
Yield_Covariates_SM_Mai[Yield_Covariates_SM_Mai$comId == "7331",] # < 1 Beobachtung

Yield_Covariates_SM_Mai[Yield_Covariates_SM_Mai$comId == "15001",] # < 4 Beobachtungen
Yield_Covariates_SM_Mai[Yield_Covariates_SM_Mai$comId == "12069",] # hier mache ich am besten nichts
Yield_Covariates_SM_Mai[Yield_Covariates_SM_Mai$comId == "14730",] # hier mache ich auch am besten nichts
Yield_Covariates_SM_Mai[Yield_Covariates_SM_Mai$comId == "12053",] # hier mache ich auch am besten nichts
...
3101, 3102, 3158, 3402, 5114, 5117, 5314, 5334, 5512, 5911, 5916, 6413, 7131, 7135, 7233, 7331, 7332, 7337, 7338, 7339, 8111, 14612, 15001, 15082, 15083, 15084, 15085, 15086, 15087, 15088, 15089, 15091, 16051, 16052 

## Generate data without outliers rstd > |5|
na.omit(Yield_Covariates_SM_Mai[rstd > 5 | rstd < -5,])  #11)

## Generate data without outliers rstd > |6.5|
na.omit(Yield_Covariates_SM_Mai[rstd > 6 | rstd < -6,])  
dim(Yield_Covariates_SM_Mai)
temp <-  Yield_Covariates_SM_Mai[!rstd > 6 & !rstd < -6,]
dim(temp)
...
r=5
glm.fit3 <- glm(formula = formula_Mai_sm_detrendlog,  data = temp)
summary(glm.fit3)
...
glm.fit4<- glm(formula = formula_Mai_sm_detrendlog,  data = temp1)
summary(glm.fit4)
plot(glm.fit4) 
...
glm.fit5<- glm(formula = formula_Mai_sm_detrendlog,  data = temp2)
summary(glm.fit5)
coeftest(glm.fit5)
plot(glm.fit5)
...
####################
## PLM Ergebnisse ##
plm.fit_Mai1 <- plm(formula = update(formula_Mai_sm_detrendlog, .~. - dummy(comId)),  data = Yield_Covariates_SM_Mai,  effect="individual", model=("within"), index = c("comId","year"))
summary(plm.fit_Mai1)

# no outliers
plm.fit_Mai2 <- plm(formula = update(formula_Mai_sm_detrendlog, .~. - dummy(comId)),  data = temp,  effect="individual", model=("within"), index = c("comId","year"))
...
plm.fit_Mai3 <- plm(formula = update(formula_Mai_sm_detrendlog, .~. - dummy(comId)),  data = temp1,  effect="individual", model=("within"), index = c("comId","year"))
...
plm.fit_Mai4 <- plm(formula = update(formula_Mai_sm_detrendlog, .~. - dummy(comId)),  data = temp2,  effect="individual", model=("within"), index = c("comId","year"))
...
plm.fit_Mai_noPrec <- plm(formula = update(formula_Mai_sm_detrendlog, .~. - dummy(comId) - poly(Prec, degree[r, 1], raw = T)),  data = temp1,  effect="individual", model=("within"), index = c("comId","year"))
...
# BIC_noprec <- rep(0,3)
# for(r in 1:3){
#   glm.fit5 <- glm(formula = update(formula_Mai_sm_detrendlog, .~. - poly(Prec_Mai, degree[r, 1], raw = T)),  data = temp2) 
...
# #### Bootstrap ####
#########################################
# boot.fn = function (data ,index)  return(coef(  plm(formula = update(formula_Mai_sm_detrendlog, .~. - dummy(comId)),  data = temp2,  effect="individual", model=("within"), index = c("comId","year"))  ))
# 
# dim(temp2)
...
## Yield vs SMI ##
plot(temp1$SMI, SM_Mai$siloMaize_logtrend- mean(Yield_Covariates_SM_Mai$siloMaize_logtrend), main="Yield vs SMI")
...
r=6
formula_Mai_sm_lintren  <- siloMaize_lintren ~ poly(Prec, degree[r, 1], raw = T) +  poly(Tavg, degree[r, 2], raw = T) + 
...
r=6
formula_Mai_sm_detrendlog <- siloMaize_logtrend ~ poly(Prec, degree[r, 1], raw = T) +  poly(Tavg, degree[r, 2], raw = T) + 
  dummy(SMI_GDM,c("severe drought","moderate drought","abnormal dry", "abnormal wet", "abundant wet","severe wet")) 
...
## Determine formula
formula_Mai_sm_Pet <- log(siloMaize) ~ poly(Prec, degree[r, 1], raw = T) +  poly(Pet, degree[r, 2], raw = T) + 
  dummy(SMI_GDM,c("severe drought","moderate drought","abnormal dry", "abnormal wet", "abundant wet","severe wet")) + log(as.integer(year))
formula_Mai_sm_Pet_detrendlog <- siloMaize_logtrend ~ poly(Prec, degree[r, 1], raw = T) +  poly(Pet, degree[r, 2], raw = T) + 
  dummy(SMI_GDM,c("severe drought","moderate drought","abnormal dry", "abnormal wet", "abundant wet","severe wet")) 
...
BIC_Pet <- rep(0,9)
       ...
       for(r in 1:9){
         glm.fit_Pet <- glm(formula= update(formula_Mai_sm_Pet_detrendlog, .~. + dummy(comId)),  data = temp1) 
         BIC_Pet[r] <- BIC(glm.fit_Pet)
       }
 ...
 r_Pet = 4 
 lm.fit_Pet <- lm(formula= update(formula_Mai_sm_Pet_detrendlog, .~. + dummy(comId)),  data = temp1) 
...
## PLM Ergebnisse ##
head(temp1)
plm.fit_Mai_Pet <- plm(formula= formula_Mai_sm_Pet,  data = temp1, effect="individual", model="within")
plm.fit_Mai_Pet_detrendlog <- plm(formula= formula_Mai_sm_Pet_detrendlog,  data = temp1, effect="individual", model="within")
