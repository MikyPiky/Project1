...
names(Yield_Covariates_Aug)
head(Yield_Covariates_Aug[,c(1,3,5,7)])
head(Yield_Covariates_Aug[,c(1:4)])
...
sd(Yield_Covariates_SM_Aug$Prec, na.rm=T)
hist(Yield_Covariates_SM_Aug$Prec)
summary(Yield_Covariates_SM_Aug$Prec)

sd(Yield_Covariates_SM_Aug$Tavg, na.rm=T)
hist(Yield_Covariates_SM_Aug$Tavg)
...
############################################
## Look at Standard Deviation of Measures ##
sd(Yield_Covariates_SM_Aug$Tavg)
summary((Yield_Covariates_SM_Aug$Tavg))
...
## Scale Covariates ##
#####################
head(Yield_Covariates_SM_Aug)[,8:length(Yield_Covariates_SM_Aug)-1]
Yield_Covariates_SM_Aug_norm <- Yield_Covariates_SM_Aug[,9:length(Yield_Covariates_SM_Aug)-1]
head(Yield_Covariates_SM_Aug_norm)
scale <- scale(Yield_Covariates_SM_Aug_norm)
summary(Yield_Covariates_SM_Aug_norm)
summary(scale)
Yield_Covariates_SM_Aug[,9:length(Yield_Covariates_SM_Aug)-1] <- scale
...
stargazer(plm.fit_SM_bestStandard_Aug, plm.fit_SM_bestStandard_Aug, plm.fit_SM_bestStandard_Aug, plm.fit_SM_bestStandard_Aug, plm.fit_SM_bestStandard_Aug,plm.fit_SM_bestStandard_Aug,
          se = se,   
          dep.var.caption  = "Model with smallest BIC (Standard Configuration) - August",
          dep.var.labels = "log(Silomaize)",
          style="default",
          model.numbers = FALSE,
          column.labels = labels1,          
...
stargazer(plm.fit_SM_noPet_Aug, plm.fit_SM_noPet_Aug, plm.fit_SM_noPet_Aug, plm.fit_SM_noPet_Aug, plm.fit_SM_noPet_Aug,plm.fit_SM_noPet_Aug,
          se = se,   
          dep.var.caption  = "Model with smallest BIC (no PET) - August",
          dep.var.labels = "log(Silomaize)",
          style="default",
          model.numbers = FALSE,
          column.labels = labels1,          
