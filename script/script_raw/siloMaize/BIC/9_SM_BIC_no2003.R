...
## Output ##
- Yield_Covariates_SM_Sep_no2003.csv (auf September_no2003 reduzierter Data.Frame)
- Export Data frame for use in BIC_Graphic: file="./data/data_raw/BIC/BIC_SM_Sep_no2003.csv")
...
###############################################
##### Save Yield_Covariates_SM_Sep_no2003tember_no2003 extern ####
...
which.min(BIC_SM_Sep_no2003$BIC[38:46])
################################################################
################################### Explore Models #############
################################################################
###################
...
r = 3 
best_formula <- formula_Sep_no2003_sm_detrendlog_PrecTavg
degree

###################
## GLM Ergebniss ##
glm.fit_SM_BEST_Sep_no2003  <- glm(formula = best_formula,  data = Yield_Covariates_SM_Sep_no2003)
summary(glm.fit_SM_BEST_Sep_no2003)
'AIC: -6738.4'
...
fixef
write.csv(fixef, "./figures/figures_exploratory/FixedEffects/Silomaize/plm.fit_SM_BEST_Sep_no2003_FE.csv")

##################
## LM Ergebniss ##
lm.fit_SM_BEST_Sep_no2003  <-lm(formula = best_formula,  data = Yield_Covariates_SM_Sep_no2003)
summary(lm.fit_SM_BEST_Sep_no2003) 
...
stargazer(plm.fit_SM_BEST_Sep_no2003, plm.fit_SM_BEST_Sep_no2003, plm.fit_SM_BEST_Sep_no2003, plm.fit_SM_BEST_Sep_no2003, plm.fit_SM_BEST_Sep_no2003,plm.fit_SM_BEST_Sep_no2003,
          ...
          type="text", out="./figures/figures_exploratory/BIC/Silomaize/SM_Sep_no2003_best.txt"
)
...
r = 3
bestStandard_formula <- formula_Sep_no2003_sm_detrendlog_SMIPrecTavg
...
rownames(fixef) <- NULL
names(fixef) <- c("comId", "FE")
write.csv(fixef, "./figures/figures_exploratory/FixedEffects/Silomaize/plm.fit_SM_bestStandard_Sep_no2003_FE.csv")
...
stargazer(plm.fit_SM_bestStandard_Sep_no2003, plm.fit_SM_bestStandard_Sep_no2003, plm.fit_SM_bestStandard_Sep_no2003, plm.fit_SM_bestStandard_Sep_no2003, plm.fit_SM_bestStandard_Sep_no2003,plm.fit_SM_bestStandard_Sep_no2003,
          se = se,   
          dep.var.caption  = "Model with smallest BIC of Standard Configuration - September_no2003",
          dep.var.labels = "log(Silomaize)",
          style="default",
          model.numbers = FALSE,
          column.labels = labels1,          
          type="text", out="./figures/figures_exploratory/BIC/Silomaize/SM_Sep_no2003_bestStandard.txt"
)
...
# r = 3
# bestSMI_formula <- formula_Sep_no2003_sm_detrendlog_SMITavg
# 
# ###################
# ## GLM Ergebniss ##
# glm.fit_SM_bestSMI_Sep_no2003  <- glm(formula = bestSMI_formula,  data = Yield_Covariates_SM_Sep_no2003)
# summary(glm.fit_SM_bestSMI_Sep_no2003)
# 'AIC: -6600.2'
# 
# ####################
# ## PLM Ergebnisse ##
...
# rownames(fixef) <- NULL
# names(fixef) <- c("comId", "FE")
# write.csv(fixef, "./figures/figures_exploratory/FixedEffects/Silomaize/plm.fit_SM_bestSMI_Sep_no2003_FE.csv")
# 
# ##################
# ## LM Ergebniss ##
...
stargazer(plm.fit_SM_bestStandard_Sep_no2003, plm.fit_SM_bestStandard_Sep_no2003, plm.fit_SM_bestStandard_Sep_no2003, plm.fit_SM_bestStandard_Sep_no2003, plm.fit_SM_bestStandard_Sep_no2003,plm.fit_SM_bestStandard_Sep_no2003,
          ...
          model.numbers = FALSE,
          column.labels = labels1,          
          type="text", out="./figures/figures_exploratory/BIC/Silomaize/SM_Sep_no2003_bestSM.txt"
)
