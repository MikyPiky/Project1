...
###############################################
##### Save Yield_Covariates_SM_Mai_fully extern ####
...
formula_list_Mai_full_sm_detrendlog
#################################################################################################
...
best_formula <- formula_Mai_full_sm_detrendlog_PrecPet

###################
## GLM Ergebniss ##
glm.fit_SM_BEST_Mai_full  <- glm(formula = best_formula,  data = Yield_Covariates_SM_Mai_full)
summary(glm.fit_SM_BEST_Mai_full)
'AIC: -6494.3'
...
fixef
write.csv(fixef, "./figures/figures_exploratory/FixedEffects/Silomaize/plm.fit_SM_BEST_Mai_full_FE.csv")

##################
## LM Ergebniss ##
lm.fit_SM_BEST_Mai_full  <-lm(formula = best_formula,  data = Yield_Covariates_SM_Mai_full)
summary(lm.fit_SM_BEST_Mai_full) 
...
nrow(Yield_Covariates_SM_Mai_full[cook_Mai_full > cutoff_SM_Mai_full,]) # 195
...
stargazer(plm.fit_SM_BEST_Mai_full, plm.fit_SM_BEST_Mai_full, plm.fit_SM_BEST_Mai_full, plm.fit_SM_BEST_Mai_full, plm.fit_SM_BEST_Mai_full,plm.fit_SM_BEST_Mai_full,
          ...
          type="text", out="./figures/figures_exploratory/BIC/Silomaize/SM_Mai_full_best.txt"
)
...
rownames(fixef) <- NULL
names(fixef) <- c("comId", "FE")
write.csv(fixef, "./figures/figures_exploratory/FixedEffects/Silomaize/plm.fit_SM_bestStandard_Mai_full_FE.csv")
...
stargazer(plm.fit_SM_bestStandard_Mai_full, plm.fit_SM_bestStandard_Mai_full, plm.fit_SM_bestStandard_Mai_full, plm.fit_SM_bestStandard_Mai_full, plm.fit_SM_bestStandard_Mai_full,plm.fit_SM_bestStandard_Mai_full,
          ...
          model.numbers = FALSE,
          column.labels = labels1,          
          type="text", out="./figures/figures_exploratory/BIC/Silomaize/SM_Mai_full_bestStandard.txt"
)
...
bestSMI_formula <- formula_Mai_full_sm_detrendlog_SMIPrecPet

###################
## GLM Ergebniss ##
glm.fit_SM_bestSMI_Mai_full  <- glm(formula = bestSMI_formula,  data = Yield_Covariates_SM_Mai_full)
s <-summary(glm.fit_SM_bestSMI_Mai_full)
s$aic
capture.output(summary(glm.fit_SM_bestSMI_Mai_full), file = "./figures/figures_exploratory/FixedEffects/Silomaize/glm.fit_SM_bestSMI_Mai_full.txt")
'AIC: -6505.5'
...
rownames(fixef) <- NULL
names(fixef) <- c("comId", "FE")
write.csv(fixef, "./figures/figures_exploratory/FixedEffects/Silomaize/plm.fit_SM_bestSMI_Mai_full_FE.csv")
...
stargazer(plm.fit_SM_bestSMI_Mai_full, plm.fit_SM_bestSMI_Mai_full, plm.fit_SM_bestSMI_Mai_full, plm.fit_SM_bestSMI_Mai_full, plm.fit_SM_bestSMI_Mai_full,plm.fit_SM_bestSMI_Mai_full,
          ...
          model.numbers = FALSE,
          column.labels = labels1,          
          type="text", out="./figures/figures_exploratory/BIC/Silomaize/SM_Mai_full_bestSM.txt"
)
