...
- Second Best of Standard Config because of Singularity

## Caveat
Best Standard: Second Best becaue of Singularity
...
names(Yield_Covariates_Sep[,c(1:4)])
names(Yield_Covariates_Sep[,c(1,3,5,7)])
...
## Scale Covariates ##
#####################
head(Yield_Covariates_SM_Sep)[,8:length(Yield_Covariates_SM_Sep)-1]
Yield_Covariates_SM_Sep_norm <- Yield_Covariates_SM_Sep[,9:length(Yield_Covariates_SM_Sep)-1]
head(Yield_Covariates_SM_Sep_norm)
scale <- scale(Yield_Covariates_SM_Sep_norm)
summary(Yield_Covariates_SM_Sep_norm)
summary(scale)
Yield_Covariates_SM_Sep[,9:length(Yield_Covariates_SM_Sep)-1] <- scale
...
stargazer(plm.fit_SM_bestStandard_Sep, plm.fit_SM_bestStandard_Sep, plm.fit_SM_bestStandard_Sep, plm.fit_SM_bestStandard_Sep, plm.fit_SM_bestStandard_Sep,plm.fit_SM_bestStandard_Sep,
          se = se,   
          dep.var.caption  = "Model with smallest BIC (Standard Configuration) - September",
          dep.var.labels = "log(Silomaize)",
          style="default",
          model.numbers = FALSE,
          column.labels = labels1,          
...
#   
#   #############################################################
#   ## If difference is smaller than 6 and modell is less complex, take second best model ##
...
stargazer(plm.fit_SM_noPet_Sep, plm.fit_SM_noPet_Sep, plm.fit_SM_noPet_Sep, plm.fit_SM_noPet_Sep, plm.fit_SM_noPet_Sep,plm.fit_SM_noPet_Sep,
          se = se,   
          dep.var.caption  = "Model with smallest BIC (no PET) - September",
          dep.var.labels = "log(Silomaize)",
          style="default",
          model.numbers = FALSE,
          column.labels = labels1,          
