...
Yield_Covariates_SM_Super[Yield_Covariates_SM_Super$comId == "6532",] # 2008 hier scheint nur ein Jahr ein Messfehler zu sein: diesen Lösche ich 
...
which.min(BIC_PetMaiPrecJulTavgAugSMIAug[1:9])
r <-8
lm.fit_PetMaiPrecJulTavgAugSMIAug  <- lm(formula = formula_Oct_sm_detrendlog_PetMaiPrecJulTavgAugSMIAug, data = Yield_Covariates_SM_Super)
summary(lm.fit_PetMaiPrecJulTavgAugSMIAug)
...
#####################################################
BIC <- c(BIC_PetMaiPrecJulTavgAugSMIAug ,BIC_PetMaiPrecJunTavgJulSMIAug, BIC_PetJunPrecJulTavgJulSMIAug,BIC_PetMaiPrecJunTavgJulSMISep,BIC_PetMaiPrecJulTavgJulSMIAug,BIC_PetJunPrecJulTavgJulSMIAug,BIC_PrecJulTavgJulSMIAug,BIC_PrecJulTavgJulSMISep,BIC_PrecJunTavgJunSMISep)
BIC
par(mfrow=c(1,1))
plot(BIC)
...
list <-c("PetMaiPrecJulTavgAugSMIAug","PetMaiPrecJunTavgJulSMIAug", "PetMaiPrecJunTavgJulSMISep")
list2 <- 1:2
