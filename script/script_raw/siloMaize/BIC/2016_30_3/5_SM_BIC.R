...
Yield_Covariates_SM_Mai[Yield_Covariates_SM_Mai$comId == "12067",] # 2006 hier scheint nur ein Jahr ein Messfehler zu sein: diesen Lösche ich 
Yield_Covariates_SM_Mai[Yield_Covariates_SM_Mai$comId == "12069",] # 2003 hier scheint nur ein Jahr ein Messfehler zu sein: diesen Lösche ich 
Yield_Covariates_SM_Mai[Yield_Covariates_SM_Mai$comId == "12067",] # 2006 hier scheint nur ein Jahr ein Messfehler zu sein: diesen Lösche ich 
 
Yield_Covariates_SM_Mai[Yield_Covariates_SM_Mai$comId == "12060",] # verändere ich nicht 


## Delete outliers ##
Yield_Covariates_SM_Mai <- Yield_Covariates_SM_Mai[!(Yield_Covariates_SM_Mai$comId == "6532" & Yield_Covariates_SM_Mai$year == "2008"),]
Yield_Covariates_SM_Mai <- Yield_Covariates_SM_Mai[!(Yield_Covariates_SM_Mai$comId == "12067" & Yield_Covariates_SM_Mai$year == "2006"),]
Yield_Covariates_SM_Mai <- Yield_Covariates_SM_Mai[!(Yield_Covariates_SM_Mai$comId == "12069" & Yield_Covariates_SM_Mai$year == "2003"),]
Yield_Covariates_SM_Mai <- Yield_Covariates_SM_Mai[!(Yield_Covariates_SM_Mai$comId == "12067" & Yield_Covariates_SM_Mai$year == "2006"),]
...
BIC_SM_5 <- BIC2
class(BIC_SM_5)
write.csv(BIC_SM_5, file="./data/data_raw/BIC/BIC_SM_5.csv")
