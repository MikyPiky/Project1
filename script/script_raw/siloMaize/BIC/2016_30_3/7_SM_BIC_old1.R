...
## Look Outliers Values ##
Yield_Covariates_SM_Jul[c(3165, 3614, ),]
## Look at other values of outliers com #
Yield_Covariates_SM_Jul[Yield_Covariates_SM_Jul$comId == "12053",] # verändere ich nicht 
Yield_Covariates_SM_Jul[Yield_Covariates_SM_Jul$comId == "15081",] # verändere ich nicht 
Yield_Covariates_SM_Jul[Yield_Covariates_SM_Jul$comId == "12065",] # verändere ich nicht 
Yield_Covariates_SM_Jul[Yield_Covariates_SM_Jul$comId == "14730",] # verändere ich nicht 

## Delete outliers ##
Yield_Covariates_SM_Jul <- Yield_Covariates_SM_Jul[!(Yield_Covariates_SM_Jul$comId == "15081" & Yield_Covariates_SM_Jul$year == "2006"),]
Yield_Covariates_SM_Jul <- Yield_Covariates_SM_Jul[!(Yield_Covariates_SM_Jul$comId == "12065" & Yield_Covariates_SM_Jul$year == "2006"),]
Yield_Covariates_SM_Jul <- Yield_Covariates_SM_Jul[!(Yield_Covariates_SM_Jul$comId == "14730" & Yield_Covariates_SM_Jul$year == "2003"),]
Yield_Covariates_SM_Jul <- Yield_Covariates_SM_Jul[!(Yield_Covariates_SM_Jul$comId == "12067" & Yield_Covariates_SM_Jul$year == "2006"),]
...
# na.omit(Yield_Covariates_SM_Jul[rstd > 5 | rstd < -5,])  #11)
# 
