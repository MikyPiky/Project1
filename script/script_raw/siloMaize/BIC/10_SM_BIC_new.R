...
## Output ##
- Yield_Covariates_SM_Oct.csv (auf Oct reduzierter Data.Frame)
...
names_Oct_lag <-    grep(c("*_lag"), names(Yield_Covariates_Oct ))
names_Oct_lag-1

head(Yield_Covariates_Oct[,names_Oct_lag-1])
Yield_Covariates_Oct <- Yield_Covariates_Oct[,names_Oct_lag-1]
names(Yield_Covariates_Oct )
...
names(Yield_Covariates_SM_Oct) <- c( "comId" , "year","com","stateId","state","siloMaize","PET", "Prec","Tavg", "SMI")
names(Yield_Covariates_SM_Oct)
...
## Scale Covariates ##
######################
Yield_Covariates_SM_Oct_unscaled <- Yield_Covariates_SM_Oct

summary(Yield_Covariates_SM_Oct_unscaled$Prec)
summary(Yield_Covariates_SM_Oct_unscaled$Tavg)
summary(Yield_Covariates_SM_Oct_unscaled$PET)

mean(Yield_Covariates_SM_Oct_unscaled$Prec)
mean(Yield_Covariates_SM_Oct_unscaled$Tavg)
mean(Yield_Covariates_SM_Oct_unscaled$PET)


sd(Yield_Covariates_SM_Oct_unscaled$Prec)
sd(Yield_Covariates_SM_Oct_unscaled$Tavg)
sd(Yield_Covariates_SM_Oct_unscaled$PET)

head(Yield_Covariates_SM_Oct)[,7:length(Yield_Covariates_SM_Oct)]
head(Yield_Covariates_SM_Oct)[,7: (length(Yield_Covariates_SM_Oct)-2) ]
Yield_Covariates_SM_Oct_norm <- Yield_Covariates_SM_Oct[,7: (length(Yield_Covariates_SM_Oct)-2) ]
head(Yield_Covariates_SM_Oct_norm)
scale <- scale(Yield_Covariates_SM_Oct_norm)
summary(Yield_Covariates_SM_Oct_norm)
summary(scale)

Yield_Covariates_SM_Oct[,7: (length(Yield_Covariates_SM_Oct)-2) ] <- scale
head(Yield_Covariates_SM_Oct)
sd(Yield_Covariates_SM_Oct_norm$Prec)
sd(Yield_Covariates_SM_Oct_norm$Tavg)
sd(Yield_Covariates_SM_Oct_norm$PET)
...
sum(table(Yield_Covariates_SM_Oct$comId) < 9 )
table(Yield_Covariates_SM_Oct$comId) < 9 
...
Yield_Covariates_SM_Oct[c(1785, 4485, 4516),]
...
# scaled
M <- cor(Yield_Covariates_SM_Oct[,7:10])
corrplot.mixed(M)


# unscaled
names(Yield_Covariates_SM_Oct_unscaled[,7:10])
M_us <- cor(Yield_Covariates_SM_Oct_unscaled[,7:10])
corrplot.mixed(M_us)
...
M_small <- cor(Yield_Covariates_SM_Oct[,c("PET","Tavg")])
...
# LM ##
lm.fit_SM_onlyFE_OCT <- lm(siloMaize_logtrend ~ dummy(comId),  data = Yield_Covariates_SM_Oct)
